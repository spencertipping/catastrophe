...
}});H.syntax.promote=function(aw){var ax=aw.constructor;return ax===String||ax===Number||ax===Boolean?new caterwaul.syntax(aw):aw};var aj=H.empty=new H.syntax("");
...
}else{return G.replace({_data:H.syntax.from_string(ax.data)})}};H.late_bound_tree=function(aF,az,aE){aE=H.merge({expression_ref_table:true},aE);aF=aF.rmap(function(aG){return aG.resolve()
});var aw=H.merge({},az,aF.expressions()),aC=new H.syntax(","),aA=new H.syntax(","),aD={};for(var ay in aw){if(ac.call(aw,ay)){aC.push(new H.syntax(ay)),aA.push(aw[ay]),aD[ay]=H.syntax.from_string(aw[ay].toString())
}}var aB=H.gensym("result"),ax=aE.expression_ref_table?V.replace({_result:aB,_expression_ref_table:H.syntax.from_object(aD)}):caterwaul.empty;return aC.length?C.replace({_bindings:aC.unflatten(),_expressions:aA.unflatten(),_result:aB,_result_init:ax,_body:aF}):aF
};H.gensym_rename_table=function(aE){var aD={},aB=[];aE.reach(function(aF){var aG=aF.data;if(f(aG)){aD[aG]||aB.push(aG)}aD[aG]=aG.replace(/^(.*)_[a-z0-9]+_.{22}$/,"$1")||"anon"
});var aw={},aC=function(aF){if(!(aF in aD)){return aF}var aG=aw[aF]||0;while(aD[aF+(++aG).toString(36)]){}return aF+(aw[aF]=aG).toString(36)};for(var ax={},az=0,ay=aB.length,aA;
az<ay;++az){ax[aA=aB[az]]||(aD[ax[aA]=aC(aD[aA])]=true)}return ax};var b=function(ax){/^:/.test(ax)&&(ax=H[ax.substr(1)]);ax.constructor===String&&(ax=ax.split(/\s+/));
for(var ay=1,aw=ax.length,az=H[ax[0]]();ay<aw;++ay){az=H[ax[ay]](az)}return az};H.init=function(aw){aw||(aw=function(ax){return true});return aw.constructor===Function?ah((function(){var ax=function(aA,ay,az){return typeof aA==="function"||aA.constructor===String?H.compile(ax.call(ax,H.parse(aA)),ay,az):aA.rmap(function(aB){return aw.call(ax,aB,ay,az)
...
};return caterwaul=H});caterwaul.module("std.all-bundle",function(a){a.all=[]});caterwaul.module("std.macro",function(c){var b=function(e){var d=function(f){if(f.constructor===Array){for(var h=0,g=f.length,j=[];
...
caterwaul.module("std.grammar",function(a){a.grammar=function(d,b,c){return(function(){var j={fix:true,descend:true},g=a.merge({},j,b),h=a.anonymizer(d),e=h(b.initial),i=function(l,k){return a[g.fix?"rereplacer":"replacer"](h(l),k.constructor===a.syntax?h(k):k)
},f=(function(k){return(g.descend?a(k):k)}).call(this,(a.alternatives(c(i,h))));return(function(k){return(function(l){return(((l)&&(this(l))))}).call(this,(f.call(f,e.replace({_x:k._expression}))))
})}).call(this)}});caterwaul.module("std.seq",(function(a,T,S,R,Q,P,O,N,M,L,K,J,I,H,G,F,E,D,C,B,A,z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,aK,aJ,aI,aH,aG,aF,aE,aD,aC,aB,aA,az,ay,ax,aw,av,au,at,ar,aq,ap,ao,an,am,al,ak,aV,aU,aT,aS,aR,aQ,aO,aN,aM,aL,aj,ai,ah,ag,af,ae,ad,ac,ab,aa,Z,Y,X,W,V,U){var aP=(function(aW){aW.seq=function(aX){return(function(aY){return(aY.modifiers.seq=aW.grammar("S",{initial:a},(function(a0,aZ){return(function(){var a1=(function(){var be=aW.anonymizer("x","y","i","j","l","lj","r","o","k"),a4=aZ(T),bx=function(bB){return(a4).replace({_body:bB})
...
}return f}).call(this,d))}}}))}).call(this)});caterwaul.module("catastrophe",(function(a,T,S,R,Q,P,O,N,M,L,K,J,I,H,G,F,E,D,C,B,A,z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a9,a8,a7,a6,a5,a4,a3,a2,a1,a0,aZ,bl,ag,aY,aX,aW,aU,aS,aQ,aO,aM,aK,aI,aG,aE,aC,aB,aA,bk,bj,bi,bh,bg,bf,bd,bc,bb,ba,az,ay,ax,aw,av,au,at,ar,aq,ap,ao,an,am,al,ak,aj,ai,ah,af,ae,ad,ac,ab,aa,Z,Y,aV,aT,aR,aP,aN,aL,aJ,aH,aF,aD,X,W,V,U){var be=(function(bm){(function(){var bs=this,bu={caterwaul:bm.deglobalize()},br=function(bv){return(function(){var bB={mocks:{},trace_native_eval_forms:true,environment:{},pre_trace:true,trace:true,timestamps:true,hook_name:bm.gensym("catastrophe_hook"),hook:null,global:bs,trace_log_size:1<<20},by=bm.merge({},bB,bv),bw=function(){return bA.apply(this,arguments)
},bx=by.trace_native_eval_forms?bt(bw):{},bz=bm.merge(bx,by.mocks),bA=(function(bC){return(bm.merge(bC.install_hook(),(function(){var bG=by,bJ=function(bK){return null
},bI=bG.trace_log,bD=bG.error_log,bH=!!bG.hook||(bG.hook=bo(bG)),bF=function(){return bG.global&&(bG.global[bG.hook_name]=bH)},bE=function(){return bG.global&&delete bG.global[bG.hook_name]
};return({options:bG,find:bJ,trace_log:bI,error_log:bD,hook:bH,install_hook:bF,remove_hook:bE})}).call(this))),bC}).call(this,(bq(bm.merge(by,{mocks:bz}))));return(bA)
}).call(this)},bp=function(bv){return(function(){var bw=function(by,bx){return(function(){var bA=function(){return bv.trace?((((bB).concat((bC))).concat((bE))).concat((bI))).concat((bJ)):[]
},bG=function(){return(function(){var bM=bv.allow_mock_annotations?bx:function(bO){return bO},bN=bv.trace_mocks?function(bO){return(bK).replace({_x:bO})}:function(bO){return bO
},bK=bx(a),bL=function(bO){return bO instanceof Function?bO:bN(bM(bm.parse(bO)))};return((function(bQ){var bO,bS,bP,bT,bR;for(var bR=new bQ.constructor(),bP=0,bT=bQ.length;
bP<bT;++bP){bO=bQ[bP],bR.push((by(bx(bm.parse(bO[0])),bL(bL(bO[1])))))}return bR}).call(this,(function(bQ){var bP=[];for(var bO in bQ){Object.prototype.hasOwnProperty.call(bQ,bO)&&bP.push([bO,bQ[bO]])
}return bP}).call(this,(bv.mocks))))}).call(this)},bB=[by(T,S),by(R,Q),by(P,O),by(N,M),by(L,K),by(J,I),by(H,G),by(F,E),by(D,C),by(B,A),by(z,y),by(x,w),by(v,u),by(t,s),by(r,q),by(p,o),by(n,m),by(l,k),by(j,i),by(h,g),by(f,e),by(d,c),by(b,a9),by(a8,a7)],bC=[by(a6,a5),by(a4,a3),by(a2,a1),by(a0,aZ)],bE=(function(){var bL=bl,bK=ag;
return((([by(aY,aX),by(aW,aU),by(aS,aQ),by(aO,aM),by(aK,aI),by(aG,aE),by(aC,aB),by(aA,bk),by(bj,bi),by(bh,bg),by(bf,bd),by(bc,bb),by(ba,az),by(ay,ax),by(aw,av),by(au,at),by(ar,aq),by(ap,ao),by(an,am),by(al,ak),by(aj,ai),by(ah,af),by(ae,ad),by(ac,ab),by(aa,Z)]).concat(((function(bO){var bM,bQ,bN,bR,bP;
for(var bP=new bO.constructor(),bN=0,bR=bO.length;bN<bR;++bN){bM=bO[bN],bP.push((by(bM[0],bM[1])))}return bP}).call(this,((bL).concat((bK))))))).concat(([by(Y,aV),by(aT,aR),by(aP,aN)])))
}).call(this),bD=new bm.syntax(bv.hook_name),bz=(aL).replace({h:bD}),bH=(aJ).replace({h:bD}),bF=function(bK){return((bv.pre_trace?bz:bH)).replace({_x:new bm.ref(bK),_value:bK})
},bI=[(function(bK){return aH/-by}) in bF(match._x)],bJ=[by(aF,aD)];return((bA()).concat((bG())))}).call(this)};return(bm.grammar(["L","U","R","C","H","S"],{initial:X},bw))
}).call(this)},bo=function(bv){return(function(){var bx=function(bG,bF){return arguments.length===2?bD(bG,bF):bw(bG)},bw=function(bF){return(bA).push({tree:bF,time:bv.timestamp&&+new Date})
},bD=function(bG,bF){return(((((by).push({tree:bG,value:bF,time:bv.timestamp&&+new Date,pre_trace:bv.pre_trace&&bz(bG)})),(((by.length>bv.trace_log_size<<1)&&(bE()))))),(bF))
},bz=function(bF){return bA.length&&bA[bA.length-1].tree===bF?bA.pop():bB(bF)},bB=function(bF){return(function(){var bG=(function(bM){var bJ,bO,bK,bP,bN;for(var bP=bM.length,bK=bP-1,bJ=bM[bK],bL;
bK>=0;--bK){bJ=bM[bK];if(bO=(bJ.tree===bF)){return bK}}return false}).call(this,bA),bI=bA[bG],bH=bA.splice(bG,bA.length-bG);return((((bC).push(bH)),(bI)))}).call(this)
},bE=function(){return by.splice(by.length-bv.trace_log_size,bv.trace_log_size)},bA=bv.pre_trace&&[],by=!!bv.trace_log||(bv.trace_log=[]),bC=bv.pre_trace&&!!bv.error_log||(bv.error_log=[]);
return(bx)}).call(this)},bn=function(bv){return function(bw){return bv(bm.parse(bw)).toString()}},bt=function(bv){return{"R[eval(_x)]":(W).replace({trace:new bm.ref(bn(bv))}),"R[new Function(_xs)]":(function(){var bz=V,bx=(U).replace({trace:new bm.ref(bn(bv))}),by=function(bA){return bA.flatten(",").map((function(bB,bC){return bC?bB:bx.replace({_x:bB})
})).unflatten()},bw=function(bA){return(bz).replace({_xs:by(bA._xs)})};return(bw)}).call(this)}},bq=function(bv){return(function(){var bx=bp(bv),bw=function(bz,by){return bx(bz,bm.merge({},bv.environment,by))
};return(instrument_and_compile)}).call(this)};return(bm.merge((catastrophe=br),bu))}).call(this)});be.caterwaul_expression_ref_table={qs:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) )'),qs1:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) )'),qs2:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) )'),qs3:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x" ) ) )'),qs4:('new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) )'),qs5:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs6:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) )'),qs7:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs8:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) )'),qs9:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_vs" ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_value" ) ) ) ) )'),qsa:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_vs" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_value" ) ) ) ) )'),qsb:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_value" ) ) ) )'),qsc:('new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_value" ) ) ) )'),qsd:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "_z" ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qse:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qsf:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_o" ) ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsg:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_o" ) ) ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qsh:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_1" ) ) ,new caterwaul.syntax( "_2" ) ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsi:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_1" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_2" ) ) ) ) ) ,new caterwaul.syntax( "_body" ) )'),qsj:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_1" ) ) ,new caterwaul.syntax( "_2" ) ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsk:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_1" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_2" ) ) ) ) ) ,new caterwaul.syntax( "_body" ) )'),qsl:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "do" ,new caterwaul.syntax( "_body" ) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ) ) )'),qsm:('new caterwaul.syntax( "do" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_body" ) ) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ) )'),qsn:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ,new caterwaul.syntax( "_body" ) ) )'),qso:('new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qsp:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "with" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsq:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "with" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qsr:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ,new caterwaul.syntax( "_body" ) ) )'),qss:('new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qst:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ,new caterwaul.syntax( "_body" ) ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "_else" ) ) ) )'),qsu:('new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_else" ) ) ) )'),qsv:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "_y" ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "_z" ) ) ) ) )'),qsw:('new caterwaul.syntax( "try" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_z" ) ) ) ) )'),qsx:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "_y" ) ) ) )'),qsy:('new caterwaul.syntax( "try" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_y" ) ) ) )'),qsz:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "_y" ) ) ) )'),qs10:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) ) )'),qs11:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x" ) ) )'),qs12:('new caterwaul.syntax( "throw" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs13:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x" ) ) )'),qs14:('new caterwaul.syntax( "return" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs15:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) ) )'),qs16:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U" ) ,new caterwaul.syntax( "_y" ) ) )'),qs17:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) ) )'),qs18:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U" ) ,new caterwaul.syntax( "_y" ) ) )'),qs19:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "switch" ) ,new caterwaul.syntax( "_value" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_cases" ) ) ) )'),qs1a:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "switch" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_value" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_cases" ) ) ) )'),qs1b:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1c:('new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1d:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x@0" ) )'),qs1e:('new caterwaul.syntax( "_x" )'),qs1f:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1g:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1h:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1i:('new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) )'),qs1j:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1k:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),ahead:("(function(xs) {var x,x0,xi,xl,xr;\nfor(var xr=new xs.constructor() ,xi=0,xl=xs.length;\nxi<xl;\n ++xi)x=xs[xi] ,xr.push( ( [caterwaul.parse( ( 'R[_x ' + (x) + ' _y]' ) ) ,caterwaul.parse( ( 'H[R[_x] ' + (x) + ' R[_y]]' ) ) ] ) ) ;\nreturn xr} ) .call(this, [ '+' , '-' , '*' , '/' , '%' , '<<' , '>>' , '>>>' , '<' , '>' , '<=' , '>=' , 'instanceof' , 'in' , '==' , '!=' , '===' , '!==' , '&' , '^' , '|' , '&&' , '||' ] )"),ahead1:("(function(xs) {var x,x0,xi,xl,xr;\nfor(var xr=new xs.constructor() ,xi=0,xl=xs.length;\nxi<xl;\n ++xi)x=xs[xi] ,xr.push( ( [caterwaul.parse( ( 'R[_x ' + (x) + ' _y]' ) ) ,caterwaul.parse( ( 'H[L[_x] ' + (x) + ' R[_y]]' ) ) ] ) ) ;\nreturn xr} ) .call(this, [ '=' , '+=' , '-=' , '*=' , '/=' , '%=' , '<<=' , '>>=' , '>>>=' , '&=' , '|=' , '^=' ] )"),qs1l:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x@0" ) )'),qs1m:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "_x" ) )'),qs1n:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "" ) )'),qs1o:('new caterwaul.syntax( "" )'),qs1p:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "delete" ,new caterwaul.syntax( "_x" ) ) )'),qs1q:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "delete" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs1r:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_f" ) ,new caterwaul.syntax( "_xs" ) ) ) )'),qs1s:('new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_f" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_xs" ) ) ) )'),qs1t:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1u:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "y" ) ) )'),qs1v:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_x" ) ) )'),qs1w:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs1x:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1y:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) )'),qs1z:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) )'),qs20:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs21:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs22:('new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) )'),qs23:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x" ) ) )'),qs24:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs25:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs26:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) )'),qs27:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "_z" ) ) )'),qs28:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) )'),qs29:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "_z" ) ) )'),qs2a:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) )'),qs2b:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "void" ,new caterwaul.syntax( "_x" ) ) )'),qs2c:('new caterwaul.syntax( "void" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs2d:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x" ) ) )'),qs2e:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2f:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs2g:('new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) )'),qs2h:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x@0" ) ) )'),qs2i:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x" ) ) )'),qs2j:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u+" ,new caterwaul.syntax( "_x" ) ) )'),qs2k:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u+" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2l:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u~" ,new caterwaul.syntax( "_x" ) ) )'),qs2m:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u~" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2n:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u-" ,new caterwaul.syntax( "_x" ) ) )'),qs2o:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u-" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2p:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "_x" ) ) )'),qs2q:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2r:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "_x" ) ) )'),qs2s:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2t:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "++" ,new caterwaul.syntax( "_x" ) ) )'),qs2u:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "++" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2v:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u--" ,new caterwaul.syntax( "_x" ) ) )'),qs2w:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u--" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2x:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "--" ,new caterwaul.syntax( "_x" ) ) )'),qs2y:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "--" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2z:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ,new caterwaul.syntax( "_z" ) ) )'),qs30:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) )'),qs31:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body" ) ) ) )'),qs32:('new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "C" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) ) ) )'),qs33:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body" ) ) ) )'),qs34:('new caterwaul.syntax( "function" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "C" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) ) ) )'),qs35:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "h" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "h" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_value" ) ) ) ) ) )'),qs36:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "h" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_value" ) ) ) )'),qs37:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "_x" ) )'),qs38:('new caterwaul.syntax( "C" )'),qs39:('new caterwaul.syntax( "null" )'),qs3a:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) )'),qs3b:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "eval" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs3c:('new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "Function" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_xs" ) ) ) )'),qs3d:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace" ) ,new caterwaul.syntax( "_x" ) )')};
return(be)}).call(this,new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("{",new caterwaul.syntax("_x"))),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("i;",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("_vs"),new caterwaul.syntax("=",new caterwaul.syntax("_name"),new caterwaul.syntax("_value"))))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("_vs"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_name"),new caterwaul.syntax("_value"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_name"),new caterwaul.syntax("_value")))),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_value")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("_x"),new caterwaul.syntax("_y")),new caterwaul.syntax("_z"))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_z")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_o")))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_o"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_1")),new caterwaul.syntax("_2")))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("in",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_1"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_2"))))),new caterwaul.syntax("_body")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_1")),new caterwaul.syntax("_2")))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("in",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_1"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_2"))))),new caterwaul.syntax("_body")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("do",new caterwaul.syntax("_body"),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("_cond"))))),new caterwaul.syntax("do",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_body")),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("_cond")),new caterwaul.syntax("_body"))),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("with"),new caterwaul.syntax("_x")),new caterwaul.syntax("_body"))),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("with"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("_cond")),new caterwaul.syntax("_body"))),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("_cond")),new caterwaul.syntax("_body"),new caterwaul.syntax("else",new caterwaul.syntax("_else")))),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body")),new caterwaul.syntax("else",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_else")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("_x"),new caterwaul.syntax("catch",new caterwaul.syntax("_y"),new caterwaul.syntax("finally",new caterwaul.syntax("_z"))))),new caterwaul.syntax("try",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x")),new caterwaul.syntax("catch",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_y")),new caterwaul.syntax("finally",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_z"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("_x"),new caterwaul.syntax("catch",new caterwaul.syntax("_y")))),new caterwaul.syntax("try",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x")),new caterwaul.syntax("catch",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_y")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("_x"),new caterwaul.syntax("finally",new caterwaul.syntax("_y")))),new caterwaul.syntax("i;",new caterwaul.syntax("try",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x"))),new caterwaul.syntax("finally",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("throw",new caterwaul.syntax("_x"))),new caterwaul.syntax("throw",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("return",new caterwaul.syntax("_x"))),new caterwaul.syntax("return",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("throw",new caterwaul.syntax("_x")),new caterwaul.syntax("_y"))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("throw",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("return",new caterwaul.syntax("_x")),new caterwaul.syntax("_y"))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("return",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("switch"),new caterwaul.syntax("_value")),new caterwaul.syntax("{",new caterwaul.syntax("_cases")))),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("switch"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_value"))),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_cases")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x@0")),new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("[]",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax(".",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("_y")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),(function(c){var a,e,b,f,d;

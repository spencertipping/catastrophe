...
caterwaul.module("std",function(a){a.js_all=function(){return this("js js_literals words seq")};a.all.push("js_all")});caterwaul.module("catastrophe",(function(I,i,h,g,f,e,d,c,b,a,bH,bG,bF,bE,bD,bC,bB,bA,bz,by,bw,bv,bu,bt,bs,br,bq,bp,bo,bn,bm,bl,bk,bi,bg,be,bj,bh,bf,bd,bc,bb,ba,a9,a8,a7,aW,aV,aU,aT,aS,aR,aQ,aP,aO,aN,aM,aL,aK,aI,aG,aE,aC,aA,ay,aw,au,ar,ap,ao,an,al,bI,am,a6,a5,a4,a3,a2,a1,a0,aZ,aY,aX,ak,aj,ai,ah,ag,af,ae,ad,ac,ab,aa,Z,Y,X,V,U,T,S,R,Q,P,O,N,M,L,K,aJ,aH,aF,aD,aB,az,ax,av,at,aq,J,H,G,F,E,D,C,B,A,z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,W){var bx=(function(bJ){(function(){var bP=bJ.context,bU=function(b2,b0,b1){return bJ.merge(b2,{xs:b0,pattern:b1},bW)
},bW={function_compiler:bJ(":all"),promote:function(b0){return b0.constructor===Function?b0:this.compile_string(b0)},compile_string:function(b0){return this.function_compiler(b0,this.match_variables_for(this.pattern),{unbound_closure:true})
},match_variables_for:function(b0){return(function(b5){for(var b4={},b3=0,b2=b5.length,b1;b3<b2;++b3){b1=b5[b3],b4[b1[0]]=b1[1]}return b4}).call(this,((function(b3){var b1,b5,b2,b6,b4;
for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;++b2){b1=b3[b2],b4.push(([b1.toString(),true]))}return b4}).call(this,((["_","x","xs","xi","r","v","t"]).concat((b0.collect(function(b1){return b1.is_wildcard()
})))))))},select:function(b0){return bU(b0,this.xs,this.pattern)},iteration_context:function(b0){return bJ.merge((this.pattern).match(this.xs[b0].tree())||{},{x:this.xs[b0]},(function(){var b4=this.xs,b6=function(b7){return(function(b9){var cd,cc,b8,ce,cb;
for(var ce=b9.length,b8=ce-1,cd,ca;b8>=0;--b8){cd=b9[b8];if(cc=(b8<=b0?cd.tree()===b7:(b8=b0+1,0))){return cd}}return false}).call(this,b4)},b2=b0,b1=function(b7){return b6(b7).value
},b3=b4[b2].tree(),b5=function(b7){return b6(b7).time};return{xs:b4,r:b6,xi:b2,v:b1,_:b3,t:b5}}).call(this))},map:function(b0){return(function(){var b1=this.promote(b0);
return(function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;++b3){b2=b4[b3],b5.push((b1(this.iteration_context(b2))))}return b5
}).call(this,this)}).call(this)},filter:function(b0){return(function(){var b1=this.promote(b0);return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;
b3<b7;++b3){b2=b4[b3],(b1(this.iteration_context(b2)))&&b5.push(b2)}return b5}).call(this,this))}).call(this)},resolved:function(){return this.select((function(b2){var b0,b4,b1,b5,b3;
for(var b3=new b2.constructor(),b1=0,b5=b2.length;b1<b5;++b1){b0=b2[b1],(this.xs[b0].resolved)&&b3.push(b0)}return b3}).call(this,this))},unresolved:function(){return this.select((function(b2){var b0,b4,b1,b5,b3;
for(var b3=new b2.constructor(),b1=0,b5=b2.length;b1<b5;++b1){b0=b2[b1],(this.xs[b0].resolved)||b3.push(b0)}return b3}).call(this,this))},to_a:function(){return(function(b2){var b0,b4,b1,b5,b3;
for(var b3=new b2.constructor(),b1=0,b5=b2.length;b1<b5;++b1){b0=b2[b1],b3.push((this.xs[b0]))}return b3}).call(this,this)},toString:function(b0){return(function(b1){return b1.join(", ")
}).call(this,((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;++b2){b1=b3[b2],b4.push((("["+(b1.tree().toString(b0||5))+"]")))
}return b4}).call(this,this.to_a())))},first:function(b0){return this.select(this.slice(0,b0||1))},last:function(b0){return this.select(this.slice(this.length-(b0||1)))
},next:function(b0){var b0=bJ.parse(b0);return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;++b2){b1=b3[b2],b4.push((b1-1))
}return b4}).call(this,(function(b4){var b7,b6,b3,b1,b5;for(var b5=new b4.constructor(),b3=0,b1=b4.length,b2;b3<b1;++b3){b7=b4[b3],(b2=((function(cb){var b8,cd,b9,ce,cc;
for(var b8,b9=0,ce=cb.length,ca;b9<ce;++b9){b8=cb[b9];if(cd=(b9>b7?(b0).match(b8.tree()):(b9=b7,0))){return b9+1}}return false}).call(this,this.xs)))&&b5.push(b2)
}return b5}).call(this,this)))},prev:function(b0){var b0=bJ.parse(b0);return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;
b2<b6;++b2){b1=b3[b2],b4.push((b1-1))}return b4}).call(this,(function(b4){var b7,b6,b3,b1,b5;for(var b5=new b4.constructor(),b3=0,b1=b4.length,b2;b3<b1;++b3){b7=b4[b3],(b2=((function(cb){var b8,cd,b9,ce,cc;
for(var ce=cb.length,b9=ce-1,b8,ca;b9>=0;--b9){b8=cb[b9];if(cd=(b9<b7?(b0).match(b8.tree()):(b9=b7,0))){return b9+1}}return false}).call(this,this.xs)))&&b5.push(b2)
}return b5}).call(this,this)))},interval:function(b0){return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;
++b2){b1=b3[b2],b4.push.apply(b4,Array.prototype.slice.call(((function(b8,b7,b9){if((b7-b8)*b9<0||!b9){return[]}for(var ca=[],cb=b7-b8;cb>=0?b8<=b7:b8>=b7;b8+=b9){ca.push(b8)
}return ca})((b1),(b0[b2]),(1)))))}return b4}).call(this,this))},step:function(b0){return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;
b2<b6;++b2){b1=b3[b2],(this.xs[b1])&&b4.push(b1)}return b4}).call(this,(function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;++b2){b1=b3[b2],b4.push((b1+b0))
}return b4}).call(this,this)))},forward:function(b0){return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;
++b2){b1=b3[b2],b4.push.apply(b4,Array.prototype.slice.call(((function(b9){var b7,cb,b8,cc,ca;for(var ca=new b9.constructor(),b8=0,cc=b9.length;b8<cc;++b8){b7=b9[b8],(this.xs[b7])&&ca.push(b7)
}return ca}).call(this,(function(b8,b7,b9){if((b7-b8)*b9<0||!b9){return[]}for(var ca=[],cb=b7-b8;cb>=0?b8<=b7:b8>=b7;b8+=b9){ca.push(b8)}return ca})((b1),(b1+b0),(1))))))
}return b4}).call(this,this))},backward:function(b0){return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;
++b2){b1=b3[b2],b4.push.apply(b4,Array.prototype.slice.call(((function(b9){var b7,cb,b8,cc,ca;for(var ca=new b9.constructor(),b8=0,cc=b9.length;b8<cc;++b8){b7=b9[b8],(this.xs[b7])&&ca.push(b7)
}return ca}).call(this,(function(b8,b7,b9){if((b7-b8)*b9<0||!b9){return[]}for(var ca=[],cb=b7-b8;cb>=0?b8<=b7:b8>=b7;b8+=b9){ca.push(b8)}return ca})((b1-b0),(b1),(1))))))
}return b4}).call(this,this))},adjacent:function(b0){return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;
++b2){b1=b3[b2],b4.push.apply(b4,Array.prototype.slice.call(((function(b9){var b7,cb,b8,cc,ca;for(var ca=new b9.constructor(),b8=0,cc=b9.length;b8<cc;++b8){b7=b9[b8],(this.xs[b7])&&ca.push(b7)
}return ca}).call(this,(function(b8,b7,b9){if((b7-b8)*b9<0||!b9){return[]}for(var ca=[],cb=b7-b8;cb>=0?b8<=b7:b8>=b7;b8+=b9){ca.push(b8)}return ca})((b1-b0),(b1+b0),(1))))))
}return b4}).call(this,this))},to:function(b0){return(this).interval(this.next(b0))},from:function(b0){return(this.prev(b0)).interval(this)}},bM=function(b0){return(function(){var b4=function(ce,cd){return arguments.length===2?cb(ce,cd):b2(ce)
},b2=function(cd){return b7.push(ca=b3(cd))},cb=function(ce,cd){return((b6(ce,cd),b0.trace_log_size&&b7.length>b0.trace_log_size<<1&&cc()),cd)},cc=function(){return b7.splice(b7.length-b0.trace_log_size,b0.trace_log_size)
},b8=function(cd){return(function(ce){return ca=(ca).find_sync(cd),ce}).call(this,(ca))},b3=function(cd){return bJ.merge(new b5(cd),{pre_time:+new Date(),pre_id:++b1,bt:ca,resolved:false})
},b6=function(ce,cd){return(function(){var cf=b0.pre_trace?b8(ce):new b5(ce);return(bJ.merge(cf,{value:cd,time:+new Date(),id:++b1,resolved:true}),!b0.pre_trace&&(b7).push(cf))
}).call(this)},b9={tree:function(){return b0.index[this.tree_id]},backtrace:function(){return(function(cf){var cd,ch,ce,ci,cg;for(var cg=[],cd=cf,ce=0,ch;ch=(cd);
++ce){cg.push(cd),cd=(cd.bt)}return cg}).call(this,this)},last_resolution:function(){return this.resolved||!this.bt?this:this.bt.last_resolution()},find_sync:function(cd){return this.tree_id===cd?this:this.bt.find_sync(cd)
},dt:function(){return this.time-this.pre_time},contains:function(cd){return !b0.pre_trace||cd.id>=this.pre_id&&cd.id<=this.id}},b5=(function(cd){return bJ.merge(cd.prototype,b9),cd
}).call(this,(function(cd){return(this.tree_id=cd,this)})),b1=0,ca=null,b7=b0.trace_log;return b4}).call(this)},bO=function(b1,b2,b0){return(function(){var b4=b2.late_bound_tree(new b2.opaque_tree(b2.module(b0))),b3=b2.compile(b1(b4),{caterwaul:b2},{gensym_renaming:false});
return b2.module(b0,b3)}).call(this)},bQ=function(b0){return(function(){var b6={mocks:{},allow_mock_annotations:true,trace_native_eval_forms:true,environment:{},closures:true,hook_name:bJ.gensym("hook"),hook:null,global:bP,trace_log_size:1<<20,patterns:null,trace:true,pre_trace:true,hook_form:null,pre_hook_form:null},b3=bJ.merge({},b6,b0),b1=function(){return b5.apply(this,arguments)
},b2=b3.trace_native_eval_forms?bR(b3.hook_name):{},b4=bJ.merge(b2,b3.mocks),b5=(function(b7){return b7.install_hook(),b7}).call(this,(bJ.merge(bN(bJ.merge(b3,{mocks:b4,trace_log:[],index:{},patterns:b3.patterns&&(function(cb){var b7,ca,cc,b8,b9;
for(var b9=new cb.constructor(),cc=0,b8=cb.length;cc<b8;++cc){b7=cb[cc],b9.push((bJ.parse(b7)))}return b9}).call(this,b3.patterns)})),(function(){var ch=b3,cc=function(){return this.find("_").unresolved()
},cb=function(ci){var ci=bJ.parse(ci);return(function(){var cj=null;return bU((function(cm){var ck,co,cl,cp,cn;for(var cn=new cm.constructor(),cl=0,cp=cm.length;
cl<cp;++cl){ck=cm[cl],cn.push((ck-1))}return cn}).call(this,(function(cm){var ck,co,cl,cq,cn;for(var cn=new cm.constructor(),cl=0,cq=cm.length,cp;cl<cq;++cl){ck=cm[cl],(cp=((cj=ck.tree())&&(ci).match(cj)&&cl+1))&&cn.push(cp)
}return cn}).call(this,ca)),ca,ci)}).call(this)},b7=function(cj,ci){return bO(this,cj,ci)},cd=function(ci){return(ci.toString()).indexOf(bJ.gensym_entropy())>-1},cf=function(cj,ci){return ci?cj.call(ch.hook,ci):cj.call(ch.hook)
},ca=ch.trace_log,ce=ch.hook?ch.hook:ch.hook=bM(ch),cg=ch.global&&(ce.trace_eval?ce.trace_eval:ce.trace_eval=bK(b1)),b9=function(){return ch.global&&(ch.global[ch.hook_name]=ce)
},b8=function(){return ch.global&&delete ch.global[ch.hook_name]};return{options:ch,unresolved:cc,find:cb,trace_module:b7,is_traced:cd,closure_state:cf,trace_log:ca,hook:ce,trace_eval:cg,install_hook:b9,remove_hook:b8}
}).call(this))));return b5}).call(this)},bL=function(b0){return(function(){var b1=function(b3,b2){return(function(){var ci=function(){return(((((b8).concat((cn))).concat((ce))).concat((b7))).concat((b5))).concat((ca))
},ch=function(){return(function(){var cq=b0.allow_mock_annotations?b2:function(cr){return cr},cp=function(cr){return cr.constructor===Function?cr:cq(bJ.parse(cr))
};return(function(ct){var cr,cv,cs,cw,cu;for(var cu=new ct.constructor(),cs=0,cw=ct.length;cs<cw;++cs){cr=ct[cs],cu.push((cc(b2(bJ.parse(cr[0])),cp(cp(cr[1])))))
}return cu}).call(this,(function(ct){var cs=[];for(var cr in ct){Object.prototype.hasOwnProperty.call(ct,cr)&&cs.push([cr,ct[cr]])}return cs}).call(this,(b0.mocks)))
}).call(this)},cf=function(cp){return(function(){var cq=function(cr){return(function(cs){return cs&&this(cs)}).call(this,(cp.call(this,cr)))};return cq}).call(this)
},cc=function(cp,cq){return cf((I).match(cq)?(function(){var cr=b3(cp,cq);return function(cs){return(function(ct){return ct&&(cs[1].id(),ct[1].id=cs[1].id),ct}).call(this,(cr.call(this,cs)))
}}).call(this):b3(cp,cq))},b8=[cc(i,h)],cn=[cc(g,f),cc(e,d),cc(c,b),cc(a,bH),cc(bG,bF),cc(bE,bD),cc(bC,bB),cc(bA,bz),cc(by,bw),cc(bv,bu),cc(bt,bs),cc(br,bq),cc(bp,bo),cc(bn,bm),cc(bl,bk),cc(bi,bg),cc(be,bj),cc(bh,bf),cc(bd,bc),cc(bb,ba),cc(a9,a8),cc(a7,aW),cc(aV,aU),cc(aT,aS),cc(aR,aQ),cc(aP,aO),cc(aN,aM),cc(aL,aK),cc(aI,aG),cc(aE,aC)],ce=[cc(aA,ay),cc(aw,au),cc(ar,ap),cc(ao,an)],b7=(function(){var cq=al,cp=bI;
return(([cc(am,a6),cc(a5,a4),cc(a3,a2),cc(a1,a0),cc(aZ,aY),cc(aX,ak),cc(aj,ai),cc(ah,ag),cc(af,ae),cc(ad,ac),cc(ab,aa),cc(Z,Y),cc(X,V),cc(U,T),cc(S,R),cc(Q,P),cc(O,N),cc(M,L),cc(K,aJ),cc(aH,aF),cc(aD,aB),cc(az,ax),cc(av,at),cc(aq,J),cc(H,G),cc(F,E),cc(D,C),cc(B,A)]).concat(((function(ct){var cr,cv,cs,cw,cu;
for(var cu=new ct.constructor(),cs=0,cw=ct.length;cs<cw;++cs){cr=ct[cs],cu.push((cc(cr[0],cr[1])))}return cu}).call(this,((cq).concat((cp))))))).concat(([cc(z,y),cc(x,w),cc(v,u)]))
}).call(this),cm=new bJ.syntax(b0.hook_name),cl=(bJ.parse(b0.pre_hook_form)||t).replace({hook:cm}),cd=(bJ.parse(b0.hook_form)||s).replace({hook:cm}),cg=function(cp){return cp.without_markers?cp.without_markers:cp.without_markers=((cp.data==="[]"&&bJ.is_gensym(cp[0].data)?cp[1]:cp)).map(cg)
},b9=function(cp){return cp.is_constant()||b0.patterns&&(function(ct){var cq,cv,cr,cw,cu;for(var cq,cr=0,cw=ct.length,cs;cr<cw;++cr){cq=ct[cr];if(cs=((cq).match(cg(cp)))){return false
}}return true}).call(this,b0.patterns)?cp:((b0.pre_trace?cl:cd)).replace({_tree:bJ.syntax.from_string(cp.id()),_value:cp})},b5=[cc(r,(b0.trace?function(cp){return b9(cp._x)
}:q))],cb=function(cp){return cp.replace(/^@/,"")},cj=p,ck=function(cp){return(o).replace({_name:bJ.syntax.from_string(cb(cp)),_v:cb(cp)})},b6=function(cp){return bJ.syntax.from_object((function(cu){for(var ct={},cs=0,cr=cu.length,cq;
cs<cr;++cs){cq=cu[cs],ct[cq[0]]=cq[1]}return ct}).call(this,((function(cs){var cq,cu,cr,cv,ct;for(var ct=new cs.constructor(),cr=0,cv=cs.length;cr<cv;++cr){cq=cs[cr],ct.push(([cb(cq),new bJ.syntax(cb(cq))]))
}return ct}).call(this,(function(cr){var cs=[];for(var cq in cr){Object.prototype.hasOwnProperty.call(cr,cq)&&cs.push(cq)}return cs}).call(this,(cp))))))},b4=function(cp){return(function(cq){return cq.length?cq:bJ.empty
}).call(this,(new bJ.syntax(",",(function(cu){var cq,ct,cv,cr,cs;for(var cs=new cu.constructor(),cv=0,cr=cu.length;cv<cr;++cv){cq=cu[cv],cs.push((ck(cq)))}return cs
}).call(this,(function(cr){var cs=[];for(var cq in cr){Object.prototype.hasOwnProperty.call(cr,cq)&&cs.push(cq)}return cs}).call(this,(cp)))).unflatten()))},co=function(cp){return(cj).replace({_hook:b0.hook_name,_get:b6(cp),_set:b4(cp)})
},ca=[cc(n,(b0.closures?function(cp){return co(cp._scope.metadata)}:m))];return(ci()).concat((ch()))}).call(this)};return(function(){var b2=bJ.grammar(["L","U","R","C","H","S"],{initial:"S[_x]",fix:false},b1),b3=function(b6){return(b6).reach(function(b7){return b0.index[b7.id()]=b7
})},b5=function(b6){return(b6).rmap(function(b7){return(function(b8){return b8!==b7?b5(b8):b7}).call(this,(b7.reduce()))})},b4=function(b6){return b2({_x:bY(b3(b5(b6)),b0)})
};return b4}).call(this)}).call(this)},bS=function(b1,b0){return(b1(b0),(b0).each(function(b2){return !(b2.data==="function")&&bS(b1,b2)}))},bX=function(b0){return(function(){var b1=function(b3){return b3.is_identifier()&&(b2[("@"+(b3.data)+"")]=b3)
},b2={};return(bS(b1,bJ.parse(b0)),b2)}).call(this)},bT=function(b0){return(function(){var b1=function(b5){return b5.data==="var"&&b3(b5[0].flatten(","))},b3=function(b5){return(function(b6){return b6.data==="in"?b2[("@"+(b6[0].data)+"")]=b6:b4(b5)
}).call(this,(b5[0].flatten("=")[0]))},b4=function(b5){return(function(b8){var b6,ca,b7,cb,b9;for(var b7=0,cb=b8.length;b7<cb;++b7){b6=b8[b7],(b2["@"+b6.flatten("=")[0].data]=b6)
}return b8}).call(this,b5)},b2=(function(b9){for(var b8={},b7=0,b6=b9.length,b5;b7<b6;++b7){b5=b9[b7],b8[b5[0]]=b5[1]}return b8}).call(this,((function(b7){var b5,b9,b6,ca,b8;
for(var b8=new b7.constructor(),b6=0,ca=b7.length;b6<ca;++b6){b5=b7[b6],b8.push((["@"+b5.data,b5]))}return b8}).call(this,(function(b7){var b5,b9,b6,ca,b8;for(var b8=new b7.constructor(),b6=0,ca=b7.length;
b6<ca;++b6){b5=b7[b6],(b5.data.length)&&b8.push(b5)}return b8}).call(this,Array.prototype.slice.call((b0[0][0].flatten(",")))))));return(bS(b1,bJ.parse(b0)),b2)}).call(this)
},bV=function(b0){return(function(){var b1=bT(b0);return(function(b4){var b2,b6,b3,b7,b5;var b5=new b4.constructor();for(var b2 in b4){if(Object.prototype.hasOwnProperty.call(b4,b2)&&!(Object.prototype.hasOwnProperty.call(b1,b2))){b5[b2]=b4[b2]
}}return b5}).call(this,bX(b0))}).call(this)},bZ=function(b0){return function(b1){return(function(b2){return b2[0][0]=new bJ.syntax(";",b2[0][0]||bJ.empty,new bJ.metadata_node(b0.closures&&bV(b1),"scope")),b2
}).call(this,(b1))}},bY=function(b1,b0){return(function(){var b2=bZ(b0);return((function(b7){var b3,b6,b8,b4,b5;for(var b8=0,b4=b7.length;b8<b4;++b8){b3=b7[b8],(b2(b3))
}return b7}).call(this,b1.collect(function(b3){return b3.data==="function"})),b1)}).call(this)},bK=function(b0){return function(b1){return b0(bJ.parse(b1)).toString()
}},bR=function(b0){return(function(){var b1=(l).replace({hook:b0});return(function(b4){var b2,b6,b3,b8,b5;var b5=new b4.constructor();for(var b7 in b4){if(Object.prototype.hasOwnProperty.call(b4,b7)){b2=b4[b7],b5[b7]=((b2).replace({trace:b1}))
}}return b5}).call(this,{"R[eval(_x)]":k,"R[new Function(_x)]":j,"R[new Function(_xs, _x)]":W})}).call(this)},bN=function(b0){return(function(){var b3=bL(b0),b2=bJ(b3),b1=function(b4,b5){return b4.constructor===String?this.find.apply(this,arguments):b2(b4,bJ.merge({},b0.environment,b5),{transparent_errors:false,gensym_renaming:false})
};return b1}).call(this)};return(function(){var b0={caterwaul:bJ,local_scope:bT,immediate_scope:bX,closure_scope:bV};return bJ.merge((catastrophe=bQ),b0)}).call(this)

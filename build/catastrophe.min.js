...
}).call(this),bD=function(bK){return(function(){var bL=function(bN,bM){return(function(){var bP=function(){return bK.trace?(((((bX).concat((bR))).concat((bS))).concat((bU))).concat((bZ))).concat((b0)):[]
},bW=function(){return(function(){var b2=bK.allow_mock_annotations?bM:function(b3){return b3},b1=function(b3){return b3 instanceof Function?b3:b2(bz.parse(b3))};
return((function(b5){var b3,b7,b4,b8,b6;for(var b6=new b5.constructor(),b4=0,b8=b5.length;b4<b8;++b4){b3=b5[b4],b6.push((bN(bM(bz.parse(b3[0])),b1(b1(b3[1])))))}return b6
}).call(this,(function(b5){var b4=[];for(var b3 in b5){Object.prototype.hasOwnProperty.call(b5,b3)&&b4.push([b3,b5[b3]])}return b4}).call(this,(bK.mocks))))}).call(this)
},bX=[bN(a,ae)],bR=[bN(ac,aa),bN(Y,W),bN(U,S),bN(Q,O),bN(K,J),bN(I,H),bN(G,F),bN(E,D),bN(C,B),bN(A,z),bN(y,x),bN(w,v),bN(u,t),bN(s,r),bN(q,p),bN(o,n),bN(m,l),bN(k,j),bN(i,h),bN(g,f),bN(e,d),bN(c,b),bN(bm,bl),bN(bk,bj)],bS=[bN(bi,bh),bN(bg,bf),bN(be,bd),bN(bc,bb)],bU=(function(){var b2=by,b1=au;
return((([bN(ba,a9),bN(a7,a5),bN(a3,a1),bN(aZ,aX),bN(aV,aT),bN(aR,aP),bN(aO,aN),bN(bx,bw),bN(bv,bu),bN(bt,bs),bN(bq,bp),bN(bo,bn),bN(aM,aL),bN(aK,aJ),bN(aI,aH),bN(aG,aF),bN(aE,aD),bN(aC,aB),bN(aA,az),bN(ay,ax),bN(aw,av),bN(at,ar),bN(aq,ap),bN(ao,an),bN(am,al)]).concat(((function(b5){var b3,b7,b4,b8,b6;
for(var b6=new b5.constructor(),b4=0,b8=b5.length;b4<b8;++b4){b3=b5[b4],b6.push((bN(b3[0],b3[1])))}return b6}).call(this,((b2).concat((b1))))))).concat(([bN(a8,a6),bN(a4,a2),bN(a0,aY),bN(aW,aU),bN(aS,aQ),bN(ak,aj),bN(ai,ah),bN(ag,af),bN(ad,ab)])))
}).call(this),bT=new bz.syntax(bK.hook_name),bO=(Z).replace({h:bT}),bY=(X).replace({h:bT}),bQ=function(b1){return b1.rmap((function(b2){return b2.data==="[]"&&bz.is_gensym(b2[0].data)?bQ(b2[1]):false
}))},bV=function(b1){return((bK.pre_trace?bO:bY)).replace({_x:new bz.ref(bQ(b1)),_value:b1})},bZ=[bN(V,function(b1){return bV(b1._x)})],b0=[bN(T,R)];return((bP()).concat((bW())))

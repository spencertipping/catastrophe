...
}return f}).call(this,d))}}}))}).call(this)});caterwaul.module("catastrophe",(function(a,T,S,R,Q,P,O,N,M,L,K,J,I,H,G,F,E,D,C,B,A,z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a8,a7,a6,a5,a4,a3,a2,a1,a0,aZ,bk,af,aY,aX,aW,aV,aT,aR,aP,aN,aL,aJ,aH,aF,aD,aB,aA,az,bj,bi,bh,bg,bf,be,bc,bb,ba,a9,ay,ax,aw,av,au,at,ar,aq,ap,ao,an,am,al,ak,aj,ai,ah,ag,ae,ad,ac,ab,aa,Z,Y,X,aU,aS,aQ,aO,aM,aK,aI,aG,aE,aC,W,V,U){var bd=(function(bl){(function(){var br=bl.context,bt={caterwaul:bl.deglobalize()},bq=function(bu){return(function(){var bA={mocks:{},allow_mock_annotations:true,trace_native_eval_forms:true,environment:{},pre_trace:true,trace:true,timestamps:true,hook_name:bl.gensym("catastrophe_hook"),hook:null,global:br,trace_log_size:1<<20},bx=bl.merge({},bA,bu),bv=function(){return bz.apply(this,arguments)
},bw=bx.trace_native_eval_forms?bs(bv):{},by=bl.merge(bw,bx.mocks),bz=(function(bB){return(bB.install_hook()),bB}).call(this,(bl.merge(bp(bl.merge(bx,{mocks:by,trace_log:[],error_log:[]})),(function(){var bE=bx,bH=function(bI){return null
},bG=bE.trace_log,bB=bE.error_log,bF=!!bE.hook||(bE.hook=bn(bE)),bD=function(){return bE.global&&(bE.global[bE.hook_name]=bF)},bC=function(){return bE.global&&delete bE.global[bE.hook_name]
};return({options:bE,find:bH,trace_log:bG,error_log:bB,hook:bF,install_hook:bD,remove_hook:bC})}).call(this))));return(bz)}).call(this)},bo=function(bu){return(function(){var bv=function(bx,bw){return(function(){var bz=function(){return bu.trace?((((bA).concat((bB))).concat((bD))).concat((bH))).concat((bI)):[]
},bF=function(){return(function(){var bK=bu.allow_mock_annotations?bw:function(bL){return bL},bJ=function(bL){return bL instanceof Function?bL:bK(bl.parse(bL))};
return((function(bN){var bL,bP,bM,bQ,bO;for(var bO=new bN.constructor(),bM=0,bQ=bN.length;bM<bQ;++bM){bL=bN[bM],bO.push((bx(bw(bl.parse(bL[0])),bJ(bJ(bL[1])))))}return bO
}).call(this,(function(bN){var bM=[];for(var bL in bN){Object.prototype.hasOwnProperty.call(bN,bL)&&bM.push([bL,bN[bL]])}return bM}).call(this,(bu.mocks))))}).call(this)
},bA=[bx(a,T),bx(S,R),bx(Q,P),bx(O,N),bx(M,L),bx(K,J),bx(I,H),bx(G,F),bx(E,D),bx(C,B),bx(A,z),bx(y,x),bx(w,v),bx(u,t),bx(s,r),bx(q,p),bx(o,n),bx(m,l),bx(k,j),bx(i,h),bx(g,f),bx(e,d),bx(c,b),bx(a8,a7)],bB=[bx(a6,a5),bx(a4,a3),bx(a2,a1),bx(a0,aZ)],bD=(function(){var bK=bk,bJ=af;
return((([bx(aY,aX),bx(aW,aV),bx(aT,aR),bx(aP,aN),bx(aL,aJ),bx(aH,aF),bx(aD,aB),bx(aA,az),bx(bj,bi),bx(bh,bg),bx(bf,be),bx(bc,bb),bx(ba,a9),bx(ay,ax),bx(aw,av),bx(au,at),bx(ar,aq),bx(ap,ao),bx(an,am),bx(al,ak),bx(aj,ai),bx(ah,ag),bx(ae,ad),bx(ac,ab),bx(aa,Z)]).concat(((function(bN){var bL,bP,bM,bQ,bO;
for(var bO=new bN.constructor(),bM=0,bQ=bN.length;bM<bQ;++bM){bL=bN[bM],bO.push((bx(bL[0],bL[1])))}return bO}).call(this,((bK).concat((bJ))))))).concat(([bx(Y,X),bx(aU,aS),bx(aQ,aO)])))
}).call(this),bC=new bl.syntax(bu.hook_name),by=(aM).replace({h:bC}),bG=(aK).replace({h:bC}),bE=function(bJ){return((bu.pre_trace?by:bG)).replace({_x:new bl.ref(bJ),_value:bJ})
},bH=[bx(aI,(function(bJ){return bE(bJ._x)}))],bI=[bx(aG,aE)];return((bz()).concat((bF())))}).call(this)};return(bl.grammar(["L","U","R","C","H","S"],{initial:aC},bv))
}).call(this)},bn=function(bu){return(function(){var bw=function(bF,bE){return arguments.length===2?bC(bF,bE):bv(bF)},bv=function(bE){return(bz).push({tree:bE,time:bu.timestamp&&+new Date})
},bC=function(bF,bE){return(((((bx).push({tree:bF,value:bE,time:bu.timestamp&&+new Date,pre_trace:bu.pre_trace&&by(bF)})),(((bx.length>bu.trace_log_size<<1)&&(bD()))))),(bE))
},by=function(bE){return bz.length&&bz[bz.length-1].tree===bE?bz.pop():bA(bE)},bA=function(bE){return(function(){var bF=(function(bL){var bI,bN,bJ,bO,bM;for(var bO=bL.length,bJ=bO-1,bI=bL[bJ],bK;
bJ>=0;--bJ){bI=bL[bJ];if(bN=(bI.tree===bE)){return bJ}}return false}).call(this,bz),bH=bz[bF],bG=bz.splice(bF,bz.length-bF);return((((bB).push(bG)),(bH)))}).call(this)
},bD=function(){return bx.splice(bx.length-bu.trace_log_size,bu.trace_log_size)},bz=bu.pre_trace&&[],bx=!!bu.trace_log||(bu.trace_log=[]),bB=bu.pre_trace&&!!bu.error_log||(bu.error_log=[]);
return(bw)}).call(this)},bm=function(bu){return function(bv){return bu(bl.parse(bv)).toString()}},bs=function(bu){return{"R[eval(_x)]":(W).replace({trace:new bl.ref(bm(bu))}),"R[new Function(_xs)]":(function(){var by=V,bw=(U).replace({trace:new bl.ref(bm(bu))}),bx=function(bz){return bz.flatten(",").map((function(bA,bB){return bB?bA:bw.replace({_x:bA})
})).unflatten()},bv=function(bz){return(by).replace({_xs:bx(bz._xs)})};return(bv)}).call(this)}},bp=function(bu){return(function(){var bx=bo(bu),bw=bl(function(by){return bx({_x:by})
}),bv=function(bz,by){return bw(bz,bl.merge({},bu.environment,by),{gensym_renaming:false})};return(bv)}).call(this)};return(bl.merge((catastrophe=bq),bt))}).call(this)
});bd.caterwaul_expression_ref_table={qs:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) )'),qs1:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) )'),qs2:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x" ) ) )'),qs3:('new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) )'),qs4:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs5:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) )'),qs6:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs7:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) )'),qs8:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_vs" ) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_value" ) ) ) ) )'),qs9:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_vs" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_value" ) ) ) ) )'),qsa:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_value" ) ) ) )'),qsb:('new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_value" ) ) ) )'),qsc:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "_z" ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsd:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qse:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_o" ) ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsf:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_o" ) ) ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qsg:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_1" ) ) ,new caterwaul.syntax( "_2" ) ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsh:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_1" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_2" ) ) ) ) ) ,new caterwaul.syntax( "_body" ) )'),qsi:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "_1" ) ) ,new caterwaul.syntax( "_2" ) ) ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsj:('new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_name" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_1" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_2" ) ) ) ) ) ,new caterwaul.syntax( "_body" ) )'),qsk:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "do" ,new caterwaul.syntax( "_body" ) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ) ) )'),qsl:('new caterwaul.syntax( "do" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_body" ) ) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ) )'),qsm:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsn:('new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qso:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "with" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsp:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "with" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qsq:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ,new caterwaul.syntax( "_body" ) ) )'),qsr:('new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) )'),qss:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond" ) ) ,new caterwaul.syntax( "_body" ) ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "_else" ) ) ) )'),qst:('new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_cond" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_else" ) ) ) )'),qsu:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "_y" ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "_z" ) ) ) ) )'),qsv:('new caterwaul.syntax( "try" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_z" ) ) ) ) )'),qsw:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "_y" ) ) ) )'),qsx:('new caterwaul.syntax( "try" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_y" ) ) ) )'),qsy:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "_y" ) ) ) )'),qsz:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) ) )'),qs10:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x" ) ) )'),qs11:('new caterwaul.syntax( "throw" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs12:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x" ) ) )'),qs13:('new caterwaul.syntax( "return" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs14:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) ) )'),qs15:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U" ) ,new caterwaul.syntax( "_y" ) ) )'),qs16:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) ) )'),qs17:('new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U" ) ,new caterwaul.syntax( "_y" ) ) )'),qs18:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "switch" ) ,new caterwaul.syntax( "_value" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_cases" ) ) ) )'),qs19:('new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "switch" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_value" ) ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_cases" ) ) ) )'),qs1a:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1b:('new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1c:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x@0" ) )'),qs1d:('new caterwaul.syntax( "_x" )'),qs1e:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1f:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1g:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1h:('new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) )'),qs1i:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1j:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),ahead:("(function(xs) {var x,x0,xi,xl,xr;\nfor(var xr=new xs.constructor() ,xi=0,xl=xs.length;\nxi<xl;\n ++xi)x=xs[xi] ,xr.push( ( [caterwaul.parse( ( 'R[_x ' + (x) + ' _y]' ) ) ,caterwaul.parse( ( 'H[R[_x] ' + (x) + ' R[_y]]' ) ) ] ) ) ;\nreturn xr} ) .call(this, [ '+' , '-' , '*' , '/' , '%' , '<<' , '>>' , '>>>' , '<' , '>' , '<=' , '>=' , 'instanceof' , 'in' , '==' , '!=' , '===' , '!==' , '&' , '^' , '|' , '&&' , '||' ] )"),ahead1:("(function(xs) {var x,x0,xi,xl,xr;\nfor(var xr=new xs.constructor() ,xi=0,xl=xs.length;\nxi<xl;\n ++xi)x=xs[xi] ,xr.push( ( [caterwaul.parse( ( 'R[_x ' + (x) + ' _y]' ) ) ,caterwaul.parse( ( 'H[L[_x] ' + (x) + ' R[_y]]' ) ) ] ) ) ;\nreturn xr} ) .call(this, [ '=' , '+=' , '-=' , '*=' , '/=' , '%=' , '<<=' , '>>=' , '>>>=' , '&=' , '|=' , '^=' ] )"),qs1k:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x@0" ) )'),qs1l:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "_x" ) )'),qs1m:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "" ) )'),qs1n:('new caterwaul.syntax( "" )'),qs1o:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "delete" ,new caterwaul.syntax( "_x" ) ) )'),qs1p:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "delete" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs1q:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_f" ) ,new caterwaul.syntax( "_xs" ) ) ) )'),qs1r:('new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_f" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_xs" ) ) ) )'),qs1s:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1t:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "y" ) ) )'),qs1u:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_x" ) ) )'),qs1v:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs1w:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs1x:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) )'),qs1y:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x" ) ) )'),qs1z:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs20:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs21:('new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) )'),qs22:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x" ) ) )'),qs23:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs24:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs25:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) )'),qs26:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "_z" ) ) )'),qs27:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) )'),qs28:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "_z" ) ) )'),qs29:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) )'),qs2a:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "void" ,new caterwaul.syntax( "_x" ) ) )'),qs2b:('new caterwaul.syntax( "void" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) )'),qs2c:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x" ) ) )'),qs2d:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2e:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ) )'),qs2f:('new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) )'),qs2g:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x@0" ) ) )'),qs2h:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x" ) ) )'),qs2i:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u+" ,new caterwaul.syntax( "_x" ) ) )'),qs2j:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u+" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2k:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u~" ,new caterwaul.syntax( "_x" ) ) )'),qs2l:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u~" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2m:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u-" ,new caterwaul.syntax( "_x" ) ) )'),qs2n:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u-" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2o:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "_x" ) ) )'),qs2p:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2q:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "_x" ) ) )'),qs2r:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2s:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "++" ,new caterwaul.syntax( "_x" ) ) )'),qs2t:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "++" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2u:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "u--" ,new caterwaul.syntax( "_x" ) ) )'),qs2v:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "u--" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2w:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "--" ,new caterwaul.syntax( "_x" ) ) )'),qs2x:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "--" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs2y:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "_y" ) ,new caterwaul.syntax( "_z" ) ) )'),qs2z:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_y" ) ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_z" ) ) ) )'),qs30:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body" ) ) ) )'),qs31:('new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "C" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) ) ) )'),qs32:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body" ) ) ) )'),qs33:('new caterwaul.syntax( "function" ,new caterwaul.syntax( "_name" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs" ) ) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "C" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_body" ) ) ) ) )'),qs34:('new caterwaul.syntax( "(" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "h" ) ,new caterwaul.syntax( "_x" ) ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "h" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_value" ) ) ) ) ) )'),qs35:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "h" ) ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x" ) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_value" ) ) ) )'),qs36:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H" ) ,new caterwaul.syntax( "_x" ) )'),qs37:('new caterwaul.syntax( "C" )'),qs38:('new caterwaul.syntax( "null" )'),qs39:('new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S" ) ,new caterwaul.syntax( "_x" ) )'),qs3a:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "eval" ) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_x" ) ) ) )'),qs3b:('new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "Function" ) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R" ) ,new caterwaul.syntax( "_xs" ) ) ) )'),qs3c:('new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace" ) ,new caterwaul.syntax( "_x" ) )')};
return(bd)}).call(this,new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("{",new caterwaul.syntax("_x"))),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("i;",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("_vs"),new caterwaul.syntax("=",new caterwaul.syntax("_name"),new caterwaul.syntax("_value"))))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("_vs"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_name"),new caterwaul.syntax("_value"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_name"),new caterwaul.syntax("_value")))),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_value")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("_x"),new caterwaul.syntax("_y")),new caterwaul.syntax("_z"))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_z")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_o")))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_o"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_1")),new caterwaul.syntax("_2")))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("in",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_1"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_2"))))),new caterwaul.syntax("_body")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_1")),new caterwaul.syntax("_2")))),new caterwaul.syntax("_body"))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("in",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_name")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_1"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_2"))))),new caterwaul.syntax("_body")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("do",new caterwaul.syntax("_body"),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("_cond"))))),new caterwaul.syntax("do",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_body")),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("_cond")),new caterwaul.syntax("_body"))),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("with"),new caterwaul.syntax("_x")),new caterwaul.syntax("_body"))),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("with"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("_cond")),new caterwaul.syntax("_body"))),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("_cond")),new caterwaul.syntax("_body"),new caterwaul.syntax("else",new caterwaul.syntax("_else")))),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_body")),new caterwaul.syntax("else",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_else")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("_x"),new caterwaul.syntax("catch",new caterwaul.syntax("_y"),new caterwaul.syntax("finally",new caterwaul.syntax("_z"))))),new caterwaul.syntax("try",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x")),new caterwaul.syntax("catch",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_y")),new caterwaul.syntax("finally",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_z"))))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("_x"),new caterwaul.syntax("catch",new caterwaul.syntax("_y")))),new caterwaul.syntax("try",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x")),new caterwaul.syntax("catch",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_y")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("_x"),new caterwaul.syntax("finally",new caterwaul.syntax("_y")))),new caterwaul.syntax("i;",new caterwaul.syntax("try",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x"))),new caterwaul.syntax("finally",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("throw",new caterwaul.syntax("_x"))),new caterwaul.syntax("throw",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("return",new caterwaul.syntax("_x"))),new caterwaul.syntax("return",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("throw",new caterwaul.syntax("_x")),new caterwaul.syntax("_y"))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("throw",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("return",new caterwaul.syntax("_x")),new caterwaul.syntax("_y"))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("return",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("switch"),new caterwaul.syntax("_value")),new caterwaul.syntax("{",new caterwaul.syntax("_cases")))),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("switch"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_value"))),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_cases")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x@0")),new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("[]",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax(".",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("_y")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),(function(c){var a,e,b,f,d;

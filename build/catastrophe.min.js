...
(function(a){return a(a)})(function(aw,ae,A){(function(aA){return aA(aA)})(function(aA){var aD=function(){var aE=function(){return aE.init.apply(aE,arguments)};return aE
},aC=typeof caterwaul==="undefined"?A:caterwaul,aB=aD();aB.deglobalize=function(){caterwaul=aC;return aB};aB.core_initializer=aA;aB.context=this;aB.merge=(function(aF){for(var aE in aF){if(aF.hasOwnProperty(aE)){return true
}}})({toString:true})?function(aI){for(var aH=1,aE=arguments.length,aG;aH<aE;++aH){if(aG=arguments[aH]){for(var aF in aG){if(Object.prototype.hasOwnProperty.call(aG,aF)){aI[aF]=aG[aF]
}}}}return aI}:function(aI){for(var aH=1,aE=arguments.length,aG;aH<aE;++aH){if(aG=arguments[aH]){for(var aF in aG){if(Object.prototype.hasOwnProperty.call(aG,aF)){aI[aF]=aG[aF]
}}if(aG.toString&&!/\[native code\]/.test(aG.toString.toString())){aI.toString=aG.toString}}}return aI},aB.modules=[];aB.module=function(aF,aE,aG){if(arguments.length===1){return aB[aF+"_initializer"]
}aF+"_initializer" in aB||aB.modules.push(aF);aG||(aG=aE,aE=null);(aB[aF+"_initializer"]=aE?aB(aE)(aG):aG)(aB);return aB};return caterwaul=aB});var e=function(aA){return aA.split(/\s+/)
},ak=function(aA,aB){return aB&&aB.call(aA,aA)||aA},c=function(aA){throw new Error(aA)},x=ae||(function(){for(var aA=[],aC="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789$_",aB=21,aD;
aB>=0;--aB){aA.push(aC.charAt(Math.random()*64>>>0))}return aA.join("")})(),k=(function(aA){return function(aB){return[aB||"",(++aA).toString(36),x].join("_")}})(0),f=function(aA){return aA.substr(aA.length-22)===x
},ar=function(aB,aA){return function(){return aB.apply(aA,arguments)}},B=function(aE,aB){for(var aC=0,aD=[],aA=aB.length;aC<aA;++aC){aD.push(aE(aB[aC],aC))}return aD
},y=function(aB,aA){return B(function(aC){return aC instanceof Array?y(aB,aC):aB(aC)})},O=function(aD){for(var aC=0,aB=e(aD),aE={},aA=aB.length;aC<aA;++aC){aE[aB[aC]]=true
}return ai(aE)},a=k("hash"),ai=function(aC){var aA=0;for(var aB in aC){af.call(aC,aB)&&(aA=aB.length>aA?aB.length:aA)}aC[a]=aA;return aC},H=function(aB,aA){return aA!=null&&!(aA.length>aB[a])&&af.call(aB,aA)
},af=Object.prototype.hasOwnProperty,K=caterwaul.merge(caterwaul,{map:B,rmap:y,gensym:k,is_gensym:f,gensym_entropy:function(){return x}}),F=O(". new ++ -- u++ u-- u+ u- typeof void u~ u! ! * / % + - << >> >>> < > <= >= instanceof in == != === !== & ^ | && || ? = += -= *= /= %= &= |= ^= <<= >>= >>>= : , return throw case var const break continue else u; ;"),aj=function(aD){for(var aC=0,aB=[false];
aC<8;++aC){aB.push.apply(aB,aB)}for(var aC=0,aA=aD.length;aC<aA;++aC){aB[aD.charCodeAt(aC)]=true}return aB},ay=aj(".0123456789"),ao=aj("0123456789"),ab=aj("0123456789abcdefABCDEFx"),h=aj("eE"),al=aj(" \n\r\t"),ap=aj("()[]{}?:"),aq=aj("([{?:"),g=aj("+-*/%&|^!~=<>?:;.,"),W=aj("\n\r"),N=aj("gims"),q=aj("'\"/"),m="/".charCodeAt(0),j="0".charCodeAt(0),C=O("++ --"),M=aj("@$_abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"),s="*".charCodeAt(0),d="\\".charCodeAt(0),P="x".charCodeAt(0),U=".".charCodeAt(0),ac="#".charCodeAt(0),au=B(O,["function","new","( [ . [] ()","delete void","u++ u-- ++ -- typeof u~ u! u+ u-","* / %","+ -","<< >> >>>","< > <= >= instanceof in","== != === !==","::",":::","&","^","|","&&","||","-> =>","case","? = += -= *= /= %= &= |= ^= <<= >>= >>>= &&= ||=",":",",","return throw break continue","var const","if else try catch finally for switch with while do",";"]),w=O("= += -= *= /= %= &= ^= |= <<= >>= >>>= &&= ||= :: ::: -> => ~ ! new typeof void u+ u- -- ++ u-- u++ ? if else function try catch finally for switch case with while do"),D=(function(aC){for(var aE={},aD=0,aA=aC.length;
aD<aA;++aD){for(var aB in aC[aD]){H(aC[aD],aB)&&(aE[aB]=aD)}}return ai(aE)})(au),X=(function(aC){for(var aE=[],aF=0,aA=aC.length,aD=null;aD=aC[aF],aE[aF]=true,aF<aA;
++aF){for(var aB in aD){if(H(aD,aB)&&(aE[aF]=aE[aF]&&!H(w,aB))){break}}}return aE})(au),ad=O("[] . () * / % + - << >> >>> < > <= >= instanceof in == != === !== & ^ | && || -> => = += -= *= /= %= &= |= ^= <<= >>= >>>= &&= ||= , : ;"),o=ai({"function":2,"if":1,"do":1,"catch":1,"try":1,"for":1,"while":1,"with":1,"switch":1}),t=ai({"if":"else","do":"while","catch":"finally","try":"catch"}),aa=O("[] ()"),az=O("return throw break continue else"),R=O("u+ u- u! u~ u++ u-- new typeof finally case var const void delete"),ah=O("; {"),Z=O("i;"),S=O("++ --"),ax=ai({"(":")","[":"]","{":"}","?":":"}),T=O("[ ("),z=O("?"),L=O("function if for while with catch void delete new typeof in instanceof"),V=O("function"),n=O(":"),p=K.syntax_common={_replace:function(aA){return(aA.l=this.l)&&(this.l.r=aA),(aA.r=this.r)&&(this.r.l=aA),this
},_append_to:function(aA){return aA&&aA._append(this),this},_reparent:function(aA){return this.p&&this.p[0]===this&&(this.p[0]=aA),this},_fold_l:function(){return this._append(this.l&&this.l._unlink(this)||am)
},_append:function(aA){return(this[this.length++]=aA)&&(aA.p=this),this},_fold_r:function(){return this._append(this.r&&this.r._unlink(this)||am)},_sibling:function(aA){return aA.p=this.p,(this.r=aA).l=this
},_fold_lr:function(){return this._fold_l()._fold_r()},_fold_rr:function(){return this._fold_r()._fold_r()},_wrap:function(aA){return aA.p=this._replace(aA).p,this._reparent(aA),delete this.l,delete this.r,this._append_to(aA)
},_unlink:function(aA){return this.l&&(this.l.r=this.r),this.r&&(this.r.l=this.l),delete this.l,delete this.r,this._reparent(aA)},pop:function(){return delete this[--this.length],this
},push:function(aA){return this[this.length++]=K.syntax.promote(aA||am),this},id:function(){var aA=k("id");return(this.id=function(){return aA})()},is_caterwaul_syntax:true,each:function(aC){for(var aB=0,aA=this.length;
aB<aA;++aB){aC(this[aB],aB)}return this},map:function(aC){for(var aD=new this.constructor(this),aB=0,aA=this.length;aB<aA;++aB){aD.push(aC(this[aB],aB)||this[aB])
}return aD},reach:function(aC){aC(this);for(var aB=0,aA=this.length;aB<aA;++aB){this[aB].reach(aC)}return this},rmap:function(aB){var aA=aB(this);return !aA||aA===this?this.map(function(aC){return aC.rmap(aB)
}):aA===true?this:aA.rmap===A?new this.constructor(aA):aA},peach:function(aC){for(var aB=0,aA=this.length;aB<aA;++aB){this[aB].peach(aC)}aC(this);return this},pmap:function(aB){var aA=this.map(function(aC){return aC.pmap(aB)
});return aB(aA)},clone:function(){return this.rmap(function(){return false})},collect:function(aB){var aA=[];this.reach(function(aC){aB(aC)&&aA.push(aC)});return aA
},replace:function(aA){var aB;return af.call(aA,this.data)&&(aB=aA[this.data])?aB.constructor===String?ak(this.map(function(aC){return aC.replace(aA)}),function(){this.data=aB
}):aB:this.map(function(aC){return aC.replace(aA)})},thin_clone:function(){return this.map(function(){return false})},repopulated_with:function(aA){return new this.constructor(this.data,aA)
},with_data:function(aA){return new this.constructor(aA,Array.prototype.slice.call(this))},change:function(aB,aA){return ak(new this.constructor(this.data,Array.prototype.slice.call(this)),function(aC){aC[aB]=aA
})},compose_single:function(aA,aB){return this.change(aA,aB(this[aA]))},slice:function(aB,aA){return new this.constructor(this.data,Array.prototype.slice.call(this,aB,aA))
},traverse:function(aA){aA({entering:this});aA({exiting:this.each(function(aB){aB.traverse(aA)})});return this},flatten:function(aA){aA=aA||this.data;return aA!==this.data?this.as(aA):!(H(ad,aA)&&this.length)?this:H(w,aA)?ak(new this.constructor(aA),ar(function(aC){for(var aB=this;
aB&&aB.data===aA;aB=aB[1]){aC.push(aB[0])}aC.push(aB)},this)):ak(new this.constructor(aA),ar(function(aD){for(var aB=this,aC=[];aB.data===aA;aB=aB[0]){aB[1]&&aC.push(aB[1])
}aC.push(aB);for(aB=aC.length-1;aB>=0;--aB){aD.push(aC[aB])}},this))},unflatten:function(){var aB=this,aA=H(w,this.data);return this.length<=2?this:ak(new this.constructor(this.data),function(aE){if(aA){for(var aD=0,aC=aB.length-1;
aD<aC;++aD){aE=aE.push(aB[aD]).push(aD<aC-2?aB.data:aB[aD])[1]}}else{for(var aD=aB.length-1;aD>=1;--aD){aE=aE.push(aD>1?aB.data:aB[0]).push(aB[aD])[0]}}})},as:function(aA){return this.data===aA?this:new K.syntax(aA).push(this)
},bindings:function(aB){var aA=aB||{};this.reach(function(aC){aC.add_bindings_to(aA)});return aA},expressions:function(aB){var aA=aB||{};this.reach(function(aC){aC.add_expressions_to(aA)
});return aA},add_bindings_to:function(aA){},add_expressions_to:function(aA){},resolve:function(){return this},reduce:function(){return this},prefix:function(aA){return this.prefixes().push(aA),this
},prefixes:function(){return this.prefix_data||(this.prefix_data=[])},infix:function(aA){return this.infixes().push(aA),this},infixes:function(){return this.infix_data||(this.infix_data=[])
},suffix:function(aA){return this.suffixes().push(aA),this},suffixes:function(){return this.suffix_data||(this.suffix_data=[])},contains:function(aD){var aA=aD(this);
if(aA){return aA}for(var aC=0,aB=this.length;aC<aB;++aC){if(aA=this[aC].contains(aD)){return aA}}},match:function(aC,aD){aC=aC.constructor===String?K.parse(aC):aC;
aD||(aD={_:aC});if(this.is_wildcard()&&(!this.leaf_nodes_only()||!aC.length)){return aD[this.without_metadata()]=aC,aD}else{if(this.length===aC.length&&this.data===aC.data){for(var aB=0,aA=this.length;
aB<aA;++aB){if(!this[aB].match(aC[aB],aD)){return null}}return aD}}},toString:function(aB){var aA=[""];this.serialize(aA,aB||-1);return aA.join("")},structure:function(){if(this.length){return"("+['"'+this.data+'"'].concat(B(function(aA){return aA.structure()
},this)).join(" ")+")"}else{return this.data}}};K.syntax_subclasses=[];K.syntax_subclass=function(aC){var aB=Array.prototype.slice.call(arguments,1),aA=function(){return aC.apply(this,arguments)
};K.merge.apply(this,[aA.prototype,p].concat(aB));K.syntax_subclasses.push(aA);aA.prototype.constructor=aA;return aA};K.syntax_extend=function(){for(var aB=0,aA=K.syntax_subclasses.length,aC=Array.prototype.slice.call(arguments);
aB<aA;++aB){K.merge.apply(this,[K.syntax_subclasses[aB].prototype].concat(aC))}K.merge.apply(this,[p].concat(aC));return K};var Q=K.parse_hex=function(aD){for(var aA=0,aC=0,aB=aD.length,aE;
aC<aB;++aC){aA*=16,aA+=(aE=aD.charCodeAt(aC))<=58?aE-48:(aE&95)-55}return aA},u=K.parse_octal=function(aD){for(var aA=0,aC=0,aB=aD.length;aC<aB;++aC){aA*=8,aA+=aD.charCodeAt(aC)-48
}return aA},av=K.unescape_string=function(aE){for(var aD=0,aF,aB=aE.length,aA=[],aC=false;aD<aB;++aD){if(aC){aC=false,aA.push((aF=aE.charAt(aD))==="\\"?"\\":aF==="n"?"\n":aF==="r"?"\r":aF==="b"?"\b":aF==="f"?"\f":aF==="0"?"\u0000":aF==="t"?"\t":aF==="v"?"\v":aF==='"'||aF==="'"?aF:aF==="x"?String.fromCharCode(Q(aE.substring(aD,++aD+1))):aF==="u"?String.fromCharCode(Q(aE.substring(aD,(aD+=3)+1))):String.fromCharCode(u(aE.substring(aD,(aD+=2)+1))))
}else{if((aF=aE.charAt(aD))==="\\"){aC=true}else{aA.push(aF)}}}return aA.join("")};K.javascript_tree_type_methods={is_string:function(){return/['"]/.test(this.data.charAt(0))
...
},as_escaped_regexp:function(){return this.data.substring(1,this.data.lastIndexOf("/"))},is_array:function(){return this.data==="["},as_unescaped_string:function(){return av(this.as_escaped_string())
},could_be_identifier:function(){return/^[A-Za-z_$@][A-Za-z0-9$_@]*$/.test(this.data)},is_identifier:function(){return this.length===0&&this.could_be_identifier()&&!this.is_boolean()&&!this.is_null_or_undefined()&&!H(F,this.data)
},has_grouped_block:function(){return H(o,this.data)},is_block:function(){return H(ah,this.data)},is_blockless_keyword:function(){return H(az,this.data)},is_null_or_undefined:function(){return this.data==="null"||this.data==="undefined"
...
},is_invisible:function(){return H(Z,this.data)},is_binary_operator:function(){return H(ad,this.data)},is_prefix_unary_operator:function(){return H(R,this.data)},is_postfix_unary_operator:function(){return H(S,this.data)
},is_unary_operator:function(){return this.is_prefix_unary_operator()||this.is_postfix_unary_operator()},precedence:function(){return D[this.data]},is_right_associative:function(){return H(w,this.data)
},is_associative:function(){return/^[,;]$/.test(this.data)},is_group:function(){return/^[(\[{][)\]]?$/.test(this.data)},accepts:function(aA){return H(t,this.data)&&t[this.data]===(aA.data||aA)
}};K.javascript_tree_metadata_methods={could_have_metadata:function(){return this.could_be_identifier()},without_metadata:function(){return this.data.replace(/@.*$/g,"")
...
}};K.javascript_tree_serialization_methods={ends_with_block:function(){var aA=this[this.length-1];if(aA&&aA.data===t[this.data]){aA=aA[0]}return this.data==="{"||H(o,this.data)&&(this.data!=="function"||this.length===3)&&aA&&aA.ends_with_block()
},never_guarded:function(){return this.is_group()||this.precedence()>D[","]},guarded:function(aD){var aE=this.never_guarded()?A:this.precedence(),aB=this.is_associative(),aC=this.is_right_associative(),aA=this.map(function(aF,aG){return aF.guarded(aE-(!aB&&!aC&&!!aG))
});return aE>aD?aA.as("("):aA},serialize:function(aC,aF){var aJ=function(aK){aG(!aB&&(!aK||M[aC[aC.length-1].charCodeAt(0)]-M[aK.charCodeAt(0)])?"":" "),aK&&aG(aK)
},aG=function(aK){aK&&aC.push(aK)},aB=this.prefix_data&&this.prefix_data.join(""),aD=this.length,aH=this.data,aA=aF-1,aE=this.infix_data&&this.infix_data.join(""),aI=this.suffix_data&&this.suffix_data.join("");
if(aF===0&&(aD||aH.length>32)){return aG("...")}switch(aD){case 0:if(H(az,aH)){return aJ(aH.replace(/^u/,"")),aG(aI)}else{if(H(ax,aH)){return aJ(aH),aG(aE),aG(ax[aH]),aG(aI)
}else{return aJ(aH),aG(aI)}}case 1:if(H(R,aH)||H(az,aH)){return aJ(aH.replace(/^u/,"")),this[0].serialize(aC,aA),aG(aI)}else{if(H(n,aH)){return this[0].serialize(aC,aA),aJ(aH),aG(aI)
}else{if(H(ax,aH)){return aJ(aH),this[0].serialize(aC,aA),aG(aE),aG(ax[aH]),aG(aI)}else{if(H(ad,aH)){return aJ(),this[0].serialize(aC,aA),aG(aI)}else{return this[0].serialize(aC,aA),aJ(aH),aG(aI)
}}}}case 2:if(H(aa,aH)){return this[0].serialize(aC,aA),aJ(aH.charAt(0)),this[1].serialize(aC,aA),aG(aE),aG(aH.charAt(1)),aG(aI)}else{if(H(o,aH)){return aJ(aH),this[0].serialize(aC,aA),this[1].serialize(aC,aA),aG(aI)
}else{if(H(Z,aH)){return this[0].serialize(aC,aA),this[1].serialize(aC,aA),aG(aI)}else{return this[0].serialize(aC,aA),aJ(aH),this[1].serialize(aC,aA),aG(aI)}}}default:if(H(z,aH)){return this[0].serialize(aC,aA),aJ(aH),this[1].precedence()>this.precedence()?(this[1].as("(").serialize(aC,aA),aG(aE),aG(":"),this[2].serialize(aC,aA),aG(aI)):(this[1].serialize(aC,aA),aG(aE),aG(":"),this[2].serialize(aC,aA),aG(aI))
}else{if(H(o,aH)){return this.accepts(this[2])&&!this[1].ends_with_block()?(aJ(aH),this[0].serialize(aC,aA),this[1].serialize(aC,aA),aG(";"),this[2].serialize(aC,aA),aG(aI)):(aJ(aH),this[0].serialize(aC,aA),this[1].serialize(aC,aA),this[2].serialize(aC,aA),aG(aI))
}else{return aJ(),this.unflatten().serialize(aC,aA),aG(aI)}}}}};K.ref_common=K.merge({},K.javascript_tree_type_methods,K.javascript_tree_metadata_methods,K.javascript_tree_serialization_methods,{replace:function(aA){var aB;
return af.call(aA,this.data)&&(aB=aA[this.data])?aB.constructor===String?ak(new this.constructor(this.value),function(){this.data=aB}):aB:this},length:0});K.ref=K.syntax_subclass(function(aB,aA){if(aB instanceof this.constructor){this.value=aB.value,this.data=aB.data
}else{this.value=aB,this.data=k(aA&&aA.constructor===String?aA:"ref")}},K.ref_common,{add_bindings_to:function(aA){aA[this.data]=this.value}});K.expression_ref=K.syntax_subclass(function(aB,aA){if(aB instanceof this.constructor){this.e=aB.e,this.data=aB.data
}else{this.e=aB,this.data=k(aA&&aA.constructor===String?aA:"e")}},K.ref_common,{add_expressions_to:function(aA){aA[this.data]=this.e}});K.metadata_node=K.syntax_subclass(function(aB,aA){if(aB instanceof this.constructor){this.metadata=aB.metadata,this.data=aB.data
}else{this.metadata=aB,this.data="@"+(aA||"")}},K.ref_common);K.opaque_tree=K.syntax_subclass(function(aD,aA){if(aD instanceof this.constructor){this.data=aD.data,this.expression_refs=aD.expression_refs
}else{this.data=aD.toString(),this.expression_refs=aA||aD.caterwaul_expression_ref_table}var aC=this.expression_refs;for(var aB in aC){af.call(aC,aB)&&aC[aB].constructor===String&&(aC[aB]=new K.opaque_tree(aC[aB]))
}},{resolve:function(){return this.expression_refs?K.late_bound_tree(new this.constructor(this.data),this.expression_refs):this},reduce:function(){return this.expression_refs?K.late_bound_tree(this.parse(),this.expression_refs):this.parse()
},guarded:function(){return this},serialize:function(aA){return aA.push(this.data),aA},parse:function(){return K.parse(this.data)}});K.syntax=ak(K.syntax_subclass(function(aF){if(aF instanceof this.constructor){this.data=aF.data,this.length=0,this.prefix_data=aF.prefix_data,this.infix_data=aF.infix_data,this.suffix_data=aF.suffix_data
}else{this.data=aF&&aF.toString();this.length=0;for(var aD=1,aA=arguments.length,aC;aC=arguments[aD],aD<aA;++aD){for(var aB=0,aH=aC.length,aE,aG;aC instanceof Array?(aE=aC[aB],aB<aH):(aE=aC,!aB);
++aB){this._append(K.syntax.promote(aE))}}}},K.javascript_tree_type_methods,K.javascript_tree_metadata_methods,K.javascript_tree_serialization_methods),function(){this.from_string=function(aA){return new K.syntax('"'+aA.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n")+'"')
};this.from_array=function(aB){for(var aC=0,aD=new K.syntax(","),aA=aB.length;aC<aA;++aC){aD.push(aB[aC])}return new K.syntax("[",aD.length?aD.unflatten():[])};this.from_object=function(aC){var aA=new K.syntax(",");
for(var aB in aC){if(af.call(aC,aB)){aA.push(new K.syntax(":",/^[$_A-Za-z][A-Za-z0-9$_]*$/.test(aB)?aB:K.syntax.from_string(aB),aC[aB].as("(")))}}return new K.syntax("{",aA.length?aA.unflatten():[])
}});K.syntax.promote=function(aA){var aB=aA.constructor;return aB===String||aB===Number||aB===Boolean?new K.syntax(aA):aA};var am=K.empty=new K.syntax("");K.parse=function(aA){if(aA==null){return aA
}if(aA.constructor===K.syntax){return aA}var a2=aA.toString().replace(/^\s*|\s*$/g,""),aF=0,bg=0,aZ=true,aY=false,bi=false,bh=false,a4=0,a0="",bd=0,ba=a2.length,aO=function(bk){return a2.charCodeAt(bk)
},aL=[],a9=null,aJ=null,aH=null,aB=B(function(){return[]},au),aI=[],a1=[am],bb=function(bk){return a1.push(bk),bk},a7=function(bk){return aJ?aJ._sibling(aJ=bk):(aJ=bk._append_to(aH)),bb(bk)
},aC=this.syntax,aG=[],aK=[],aX=[],aV=function(){var bk=aX;aX=[];return bk},a5=function(bk){bk.prefix_data=aV();return bb(bk)};if(ba===0){return am}while((aF=bd)<ba){aY=bh=bi=a0=0;
if(al[bg=aO(bd)]){while(++bd<ba&&al[aO(bd)]){}}else{if(ap[bg]){++bd,a0=1,aZ=aq[bg]}else{if(bg===m&&aO(bd+1)===s&&(bd+=2)){while(++bd<=ba&&(aO(bd-1)!==m||aO(bd-2)!==s)){}}else{if(bg===m&&aO(bd+1)===m){while(++bd<=ba&&!W[aO(bd-1)]){}}else{if(bg===ac){while(++bd<=ba&&!W[aO(bd-1)]){}}else{if(q[bg]&&(a4=bg)&&aZ&&!(aZ=!(a0=a2.charAt(bd)))){while(++bd<ba&&(bg=aO(bd))!==a4||aY){aY=!aY&&bg===d
}while(++bd<ba&&N[aO(bd)]){}a0=1}else{if(bg===j&&ab[aO(bd+1)]){while(++bd<ba&&ab[aO(bd)]){}aZ=!(a0=1)}else{if(ay[bg]&&(bg!==U||ao[aO(bd+1)])){while(++bd<ba&&(ao[bg=aO(bd)]||bi^(bi|=bg===U)||bh^(bh|=h[bg]&&++bd))){}while(bd<ba&&ao[aO(bd)]){++bd
}aZ=!(a0=1)}else{if(g[bg]&&(a0=aZ?"u":"",aZ=true)){while(bd<ba&&g[aO(bd)]&&H(F,a0+a2.charAt(bd))){a0+=a2.charAt(bd++)}aZ=!H(C,a0)}else{while(++bd<ba&&(M[bg=aO(bd)]||bg>127)){}aZ=H(F,a0=a2.substring(aF,bd))
}}}}}}}}}if(bd===aF){throw new Error('Caterwaul lex error at "'+a2.substr(aF,80)+'" with leading context "'+a2.substr(aF-80,80)+'" (probably a Caterwaul bug)')}if(a0===0){aX.push(a2.substring(aF,bd));
continue}a0=a0===1?a2.substring(aF,bd):a0==="u;"?";":a0;a0===a9?(aL.pop(),a9=aL[aL.length-1],(aJ||aH).infix_data=aV(),aJ=aJ?aJ.p:aH,aH=null):(H(ax,a0)?(aL.push(a9=ax[a0]),aH=a7(a5(new aC(a0))),aG.push(aH),aJ=null):a7(a5(new aC(a0))),H(D,a0)&&aB[D[a0]].push(aJ||aH));
aZ|=a0===")"&&aJ.l&&H(o,aJ.l.data)}for(var bd=0,ba=aB.length,aW,bj;bj=aB[bd],aW=X[bd],bd<ba;++bd){for(var bc=aW?0:bj.length-1,aU=bj.length,be=aW?1:-1,aS,bf,a3,aT,aR;
aW?bc<aU:bc>=0;bc+=be){if(H(ad,bf=(aS=bj[bc]).data)){if(bf===":"&&D[aS.r.data]>bd){aS._fold_l()}else{aS._fold_lr()}}else{if(bf==="new"){for(var aN=[aS.r._unlink(aS)];
(a3=aS.r)&&/^[\[\.]$/.test(a3.data);){aN.push(aS.r._unlink(aS)),a3.data==="."&&aN.push(aS.r._unlink(aS))}if(a3&&a3.data==="("){aN.push(aS.r._unlink(aS))}aS._append(aN[0]);
for(var aQ=1,aP=aN.length;aQ<aP;++aQ){aN[aQ-1]._sibling(aN[aQ])}}else{if(H(T,bf)&&aS.l&&!((aT=aS.l.l)&&H(o,aT.data))&&(aS.l.data==="."||(aS.l.data==="function"&&aS.l.length===2)||!(H(F,aS.l.data)||H(L,aS.l.data)))){aI.push(aS.l._wrap(bb(new aC(bf+ax[bf]))).p._fold_r())
}else{if(H(S,bf)){aS._fold_l()}else{if(H(R,bf)){aS._fold_r()}else{if(H(z,bf)){aS._fold_lr(),aK.push(aS)}else{if(H(o,bf)&&aS.r&&aS.r.data!==":"){for(var a6=0,aM=o[bf];
a6<aM&&aS.r&&!H(ah,aS.r.data);++a6){aS._fold_r()}aS.r&&(aS.r.data===";"?aS.push(am):aS._fold_r());if(H(t,bf)&&t[bf]===(aS.r&&aS.r.r&&aS.r.r.data)){aS._fold_r().pop()._fold_r()
}else{if(H(t,bf)&&t[bf]===(aS.r&&aS.r.data)){aS._fold_r()}}}else{if(H(az,bf)){aS.r&&aS.r.data!==";"&&aS._fold_r()}}}}}}}}}}for(var bd=a1.length-1,bj;bd>=0;--bd){(bj=a1[bd]).r&&bj._wrap(bb(new aC("i;"))).p._fold_r()
}for(var bd=0,ba=aI.length,bj,aD;bd<ba;++bd){(aD=(bj=aI[bd])[1]=bj[1][0]||am)&&(aD.p=bj)}for(var bd=0,ba=aG.length,bj;bd<ba;++bd){(bj=aG[bd]).length||bj.push(am)
}for(var bd=0,ba=aK.length,bj,a8,aE;bd<ba;++bd){a8=(bj=aK[bd]).length,aE=bj[0],bj[0]=bj[a8-2],bj[1]=aE,bj[2]=bj[a8-1],bj.length=3}while(aJ.p){aJ=aJ.p}for(var bd=a1.length-1,bj;
bd>=0;--bd){delete (bj=a1[bd]).p,delete bj.l,delete bj.r}aJ.suffix_data=aX;return aJ};var ag=K.parse("var _bindings; return(_expression)"),r=K.parse("_variable = _base._variable"),l=K.parse("undefined = void(0)"),E=K.parse("(function (_bindings) {var _result=(_body);_result_init;return(_result)}).call(this, _expressions)"),Y=K.parse("_result.caterwaul_expression_ref_table = _expression_ref_table");
K.compile=function(aL,aF,aK){aK=K.merge({gensym_renaming:true,transparent_errors:false,unbound_closure:false,guard:true},aK);aL=K.late_bound_tree(aL,null,aK);if(aK.guard){aL=aL.guarded()
}var aC=K.merge({},this._environment,aF,aL.bindings()),aH=[l],aJ=k("base");for(var aE in aC){if(af.call(aC,aE)&&aE!=="this"){aH.push(r.replace({_variable:aE,_base:aJ}))
}}var aI=new this.syntax(",",aH).unflatten(),aA=ag.replace({_bindings:aI,_expression:aL});if(aK.gensym_renaming){var aD=this.gensym_rename_table(aA);for(var aE in aC){af.call(aC,aE)&&(aC[aD[aE]||aE]=aC[aE])
}aA=aA.replace(aD);aJ=aD[aJ]}var aB=aA.toString(),aG=(function(){if(aK.transparent_errors){return new Function(aJ,aB)}else{try{return new Function(aJ,aB)}catch(aM){throw new Error((aM.message||aM)+" while compiling "+aB)
}}})();return aK.unbound_closure?aG:aG.call(aC["this"],aC)};var I=K.parse("new caterwaul.syntax(_data)"),v=K.parse("new caterwaul.syntax(_data, _xs)"),i=K.parse("_x.prefix(_y)"),an=K.parse("_x.infix(_y)"),J=K.parse("_x.suffix(_y)");
K.node_padding_annotations=function(aD,aE){for(var aB=aD.prefixes(),aC=0,aA=aB.length;aC<aA;++aC){aE=i.replace({_x:aE,_y:K.syntax.from_string(aB[aC])})}for(var aB=aD.infixes(),aC=0,aA=aB.length;
aC<aA;++aC){aE=an.replace({_x:aE,_y:K.syntax.from_string(aB[aC])})}for(var aB=aD.suffixes(),aC=0,aA=aB.length;aC<aA;++aC){aE=J.replace({_x:aE,_y:K.syntax.from_string(aB[aC])})
}return aE};K.syntax_to_expression=function(aB){if(aB.length){for(var aA=new K.syntax(","),aD=0,aC=aB.length;aD<aC;++aD){aA.push(K.syntax_to_expression(aB[aD]))}return K.node_padding_annotations(aB,v.replace({_data:K.syntax.from_string(aB.data),_xs:aA.unflatten()}))
}else{return K.node_padding_annotations(aB,I.replace({_data:K.syntax.from_string(aB.data)}))}};K.late_bound_tree=function(aJ,aD,aI){aI=K.merge({expression_ref_table:true},aI);
aJ=aJ.rmap(function(aK){return aK.resolve()});var aA=K.merge({},aD,aJ.expressions()),aG=new K.syntax(","),aE=new K.syntax(","),aH={};for(var aC in aA){if(af.call(aA,aC)){aG.push(new K.syntax(aC)),aE.push(aA[aC]),aH[aC]=K.syntax.from_string(aA[aC].toString())
}}var aF=K.gensym("result"),aB=aI.expression_ref_table?Y.replace({_result:aF,_expression_ref_table:K.syntax.from_object(aH)}):K.empty;return aG.length?E.replace({_bindings:aG.unflatten(),_expressions:aE.unflatten(),_result:aF,_result_init:aB,_body:aJ}):aJ
};K.gensym_rename_table=function(aI){var aH={},aF=[];aI.reach(function(aJ){var aK=aJ.data;if(f(aK)){aH[aK]||aF.push(aK)}aH[aK]=aK.replace(/^(.*)_[a-z0-9]+_.{22}$/,"$1")||"anon"
});var aA={},aG=function(aJ){if(!(aJ in aH)){return aJ}var aK=aA[aJ]||0;while(aH[aJ+(++aK).toString(36)]){}return aJ+(aA[aJ]=aK).toString(36)};for(var aB={},aD=0,aC=aF.length,aE;
aD<aC;++aD){aB[aE=aF[aD]]||(aH[aB[aE]=aG(aH[aE])]=true)}return aB};var b=function(aB){/^:/.test(aB)&&(aB=K[aB.substr(1)]);aB.constructor===String&&(aB=aB.split(/\s+/));
for(var aC=1,aA=aB.length,aD=K[aB[0]]();aC<aA;++aC){aD=K[aB[aC]](aD)}return aD};K.init=function(aA){aA||(aA=function(aB){return true});return aA.constructor===Function?ak((function(){var aB=function(aE,aC,aD){return typeof aE==="function"||aE.constructor===String?K.compile(aB.call(aB,K.parse(aE)),aC,aD):aE.rmap(function(aF){return aA.call(aB,aF,aC,aD)
})};return aB})(),function(){this.global=K,this.macroexpander=aA}):b(aA)};K.initializer=aw;K.clone=function(){return ak(aw(aw,x).deglobalize(),function(){for(var aA in K){this[aA]||(this[aA]=K[aA])
}})};var at=K.parse("(function (f) {return f(f)})(_x)"),G=K.parse("module(_name, _f)");K.replicator=function(aD){if(aD&&aD.minimal_core_only){return at.replace({_x:new this.opaque_tree(this.core_initializer)})
}if(aD&&aD.core_only){return at.replace({_x:new this.opaque_tree(this.initializer)})}for(var aE=0,aC=aD&&aD.modules||this.modules,aF=[],aB=aC.length;aE<aB;++aE){aF.push(G.replace({_name:this.syntax.from_string(aC[aE]),_f:new this.opaque_tree(this.module(aC[aE]))}))
}for(var aE=0,aB=aF.length,aA=new this.syntax(".",at.replace({_x:new this.opaque_tree(this.initializer)}));aE<aB;++aE){aA.push(aF[aE])}return this.late_bound_tree(aA.unflatten())
...
};g.qf=d.reexpander(function(h){return e.replace({_body:d.parse(h.as_unescaped_string())})})})(f.literal_modifiers.string);return f}});a.caterwaul_expression_ref_table={qs1:(' new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_")) .prefix( " ") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_body") .prefix( " "))) .prefix( " "))'),qs2:(' new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_regexp") ,new caterwaul.syntax( "exec")) ,new caterwaul.syntax( "_"))')};
return(a)}).call(this,new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_")).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax("return",new caterwaul.syntax("_body").prefix(" "))).prefix(" ")),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_regexp"),new caterwaul.syntax("exec")),new caterwaul.syntax("_"))));
...
return(aP)}).call(this,new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_expression")),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_xs")).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_x0").prefix(" ")),new caterwaul.syntax("_xi").prefix(" ")),new caterwaul.syntax("_xl").prefix(" ")),new caterwaul.syntax("_xr").prefix(" "))),new caterwaul.syntax("_body").prefix(" "))).prefix(" "))),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_s")))),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("(",new caterwaul.syntax("_f"))))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix("                                        ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix("                              "),new caterwaul.syntax("0").prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xs").prefix(" ")).prefix("                                                  ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("apply")),new caterwaul.syntax(",",new caterwaul.syntax("_xr"),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Array").prefix(" "),new caterwaul.syntax("prototype")),new caterwaul.syntax("slice")),new caterwaul.syntax("call")),new caterwaul.syntax("(",new caterwaul.syntax("_f"))))))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("_x0").prefix(" ")),new caterwaul.syntax("_xl").prefix(" "))),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("_x").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix("    "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("_x"))).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix("      ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix("    "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("||",new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("_x"))).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix("      ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("y").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("y"),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("y"))).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("_x0").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("_x0"),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("_f"))).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("0"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("1").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix("            "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_x0").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax("2").prefix(" ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax("_xl"),new caterwaul.syntax("1").prefix(" ")).prefix(" "))).prefix(" "))),new caterwaul.syntax(">=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("u--",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_x0").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" "))),new caterwaul.syntax("!==",new caterwaul.syntax("_x").prefix("                      "),new caterwaul.syntax("null").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("_x")),new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix("   ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix("      "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_x0").prefix(" ")).prefix("      ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length")),new caterwaul.syntax("1").prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" "))),new caterwaul.syntax(">=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("u--",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_x0").prefix(" ")).prefix("      ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("_x0").prefix(" "))),new caterwaul.syntax("=",new caterwaul.syntax("_x0").prefix("          "),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("_x")),new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix("        ")),new caterwaul.syntax("i;",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("=",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("x"),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("x").prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("false").prefix(" ")).prefix(" ")),new caterwaul.syntax("i;",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("=",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("x"),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("false").prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("true").prefix(" ")).prefix(" ")),new caterwaul.syntax("i;",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax("1").prefix(" ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("_x").prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax(">=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("u--",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("=",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("x"),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("x").prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("false").prefix(" ")).prefix(" ")),new caterwaul.syntax("i;",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("_xl").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("=",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("_x0"),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("_f").prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("false").prefix(" ")).prefix(" ")),new caterwaul.syntax("i;",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("length"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax("_xl").prefix(" "),new caterwaul.syntax("1").prefix(" ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("_x").prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax(">=",new caterwaul.syntax("_xi").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("u--",new caterwaul.syntax("_xi")).prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("=",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_xi"))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("_x0"),new caterwaul.syntax("(",new caterwaul.syntax("_init")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("_f").prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("false").prefix(" ")).prefix(" ")),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_xs"))),new caterwaul.syntax("concat")),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_ys")))),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("_x").prefix(" ")))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("_f")),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_x"))).prefix(" ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("_x").prefix(" ")))).prefix(" "),new caterwaul.syntax("_f").prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("_xs").prefix(" ")).prefix("                ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix("      ")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr").prefix("  "),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_x"))).prefix(" ")).prefix(" ")).prefix("    ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("u!",new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix("    ")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr").prefix("  "),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_x"))).prefix(" ")).prefix(" ")).prefix("    ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("x"),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("x")),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("_x"))).prefix("  ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix("  "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("k").prefix(" ")))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("k"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("k")),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" "))).prefix(" ")).prefix("    ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix("  "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("k").prefix(" ")))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("k"))).prefix(" "),new caterwaul.syntax("_f").prefix(" "))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("_xs").prefix(" ")).prefix("            ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix("  "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("k").prefix(" ")))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("k"))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix("        "),new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr"),new caterwaul.syntax("k")),new caterwaul.syntax("_x").prefix(" ")).prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")).prefix("    ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix("  "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("k").prefix(" ")))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("k"))).prefix(" "),new caterwaul.syntax("||",new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix("        "),new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr"),new caterwaul.syntax("k")),new caterwaul.syntax("_x").prefix(" ")).prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")).prefix("    ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_xr").prefix(" "),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("constructor")),new caterwaul.syntax(""))).prefix(" ")).prefix(" "),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix("  "),new caterwaul.syntax("_xs").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object"),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("_xs"),new caterwaul.syntax("k").prefix(" ")))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("_x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("_xs").prefix(" "),new caterwaul.syntax("k"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("x").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_f")).prefix(" ")).prefix(" ")),new caterwaul.syntax("&&",new caterwaul.syntax("x").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("_xr"),new caterwaul.syntax("k")),new caterwaul.syntax("x").prefix("  ")).prefix(" ")).prefix(" ")).prefix(" "))).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("_xr").prefix(" ")).prefix(" ")),new caterwaul.syntax("u~",new caterwaul.syntax("u!",new caterwaul.syntax("_x"))),new caterwaul.syntax("u!",new caterwaul.syntax("_x")),new caterwaul.syntax("()",new caterwaul.syntax("_f"),new caterwaul.syntax(",",new caterwaul.syntax("_x"),new caterwaul.syntax("_x0"))),new caterwaul.syntax("()",new caterwaul.syntax("_f"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("_var@0"),new caterwaul.syntax("_init")),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("[",new caterwaul.syntax("_init")),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("_var@0"),new caterwaul.syntax("_x")),new caterwaul.syntax("[",new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("+",new caterwaul.syntax("_xs"),new caterwaul.syntax("_ys").prefix(" ")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("(",new caterwaul.syntax("_x"))),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("_y")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("()",new caterwaul.syntax("_xs"),new caterwaul.syntax("_ys"))),new caterwaul.syntax("()",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_xs")),new caterwaul.syntax("_ys")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[",new caterwaul.syntax("_x"))),new caterwaul.syntax("[",new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(",",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" "))),new caterwaul.syntax(",",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(".",new caterwaul.syntax("_xs"),new caterwaul.syntax("_p"))),new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_xs")),new caterwaul.syntax("_p")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("u~",new caterwaul.syntax("[",new caterwaul.syntax("_x")))),new caterwaul.syntax("[",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("u~",new caterwaul.syntax("()",new caterwaul.syntax("_xs"),new caterwaul.syntax("_ys")))),new caterwaul.syntax("()",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_xs")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_ys"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("?",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" ").infix(" "),new caterwaul.syntax("_z").prefix(" ")).prefix(" ")),new caterwaul.syntax("?",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))).prefix(" ").infix(" "),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_z"))).prefix(" ")).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("&&",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" ")).prefix(" ")),new caterwaul.syntax("&&",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))).prefix(" ")).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("||",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" ")).prefix(" ")),new caterwaul.syntax("||",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_y"))).prefix(" ")).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("u+",new caterwaul.syntax("_xs"))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Array"),new caterwaul.syntax("prototype")),new caterwaul.syntax("slice")),new caterwaul.syntax("call")),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_xs")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("%",new caterwaul.syntax("_xs"),new caterwaul.syntax("_thing")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("*",new caterwaul.syntax("_xs"),new caterwaul.syntax("_thing")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("/",new caterwaul.syntax("_xs"),new caterwaul.syntax("_thing")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("|",new caterwaul.syntax("_xs"),new caterwaul.syntax("_thing")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("*",new caterwaul.syntax("%",new caterwaul.syntax("_xs"),new caterwaul.syntax("k")).prefix(" "),new caterwaul.syntax("_thing"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("*",new caterwaul.syntax("%",new caterwaul.syntax("_xs"),new caterwaul.syntax("v")).prefix(" "),new caterwaul.syntax("_thing"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("%",new caterwaul.syntax("%",new caterwaul.syntax("_xs"),new caterwaul.syntax("k")).prefix(" "),new caterwaul.syntax("_thing"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("%",new caterwaul.syntax("%",new caterwaul.syntax("_xs"),new caterwaul.syntax("v")).prefix(" "),new caterwaul.syntax("_thing"))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("o")).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax("_body")).prefix(" "))),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("this"),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_o"))).prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("i"),new caterwaul.syntax("u").prefix(" ")),new caterwaul.syntax("s").prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("<=",new caterwaul.syntax("*",new caterwaul.syntax("(",new caterwaul.syntax("-",new caterwaul.syntax("u"),new caterwaul.syntax("i").prefix(" ")).prefix(" ")),new caterwaul.syntax("s").prefix(" ")).prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix("      ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("d").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax("u").prefix(" "),new caterwaul.syntax("i").prefix(" ")).prefix(" ")).prefix(" "))),new caterwaul.syntax("?",new caterwaul.syntax(">=",new caterwaul.syntax("d").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" "),new caterwaul.syntax("<",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("u").prefix("  ").infix(" ")).prefix(" "),new caterwaul.syntax(">",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("u").prefix("  ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("+=",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("s").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("i"))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("r").prefix(" ")).prefix(" "))).prefix(" "))),new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("(",new caterwaul.syntax("_l")),new caterwaul.syntax("(",new caterwaul.syntax("_u")).prefix(" ")),new caterwaul.syntax("(",new caterwaul.syntax("_step")).prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax("(",new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("i"),new caterwaul.syntax("u").prefix(" ")),new caterwaul.syntax("s").prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("||",new caterwaul.syntax("<",new caterwaul.syntax("*",new caterwaul.syntax("(",new caterwaul.syntax("-",new caterwaul.syntax("u"),new caterwaul.syntax("i").prefix(" ")).prefix(" ")),new caterwaul.syntax("s").prefix(" ")).prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" "),new caterwaul.syntax("u!",new caterwaul.syntax("s")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("d").prefix(" "),new caterwaul.syntax("-",new caterwaul.syntax("u").prefix(" "),new caterwaul.syntax("i").prefix(" ")).prefix(" ")).prefix(" "))),new caterwaul.syntax("?",new caterwaul.syntax(">=",new caterwaul.syntax("d").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" "),new caterwaul.syntax("<=",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("u").prefix(" ").infix(" ")).prefix(" "),new caterwaul.syntax(">=",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("u").prefix(" ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("+=",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("s").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("i"))).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("r").prefix(" ")).prefix(" "))).prefix(" "))),new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("(",new caterwaul.syntax("_l")),new caterwaul.syntax("(",new caterwaul.syntax("_u")).prefix(" ")),new caterwaul.syntax("(",new caterwaul.syntax("_step")).prefix(" "))),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("ks").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix(" "),new caterwaul.syntax("o").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object").prefix(" "),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("o"),new caterwaul.syntax("k").prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("ks").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("k"))).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("ks").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("vs").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix(" "),new caterwaul.syntax("o").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object").prefix(" "),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("o"),new caterwaul.syntax("k").prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("vs").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("[]",new caterwaul.syntax("o"),new caterwaul.syntax("k")))).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("vs").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("ps").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" ")),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("k").prefix(" "),new caterwaul.syntax("o").prefix(" ")).prefix(" "))).prefix(" "),new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax(".",new caterwaul.syntax("Object").prefix(" "),new caterwaul.syntax("prototype")),new caterwaul.syntax("hasOwnProperty")),new caterwaul.syntax("call")),new caterwaul.syntax(",",new caterwaul.syntax("o"),new caterwaul.syntax("k").prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("ps").prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("[",new caterwaul.syntax(",",new caterwaul.syntax("k"),new caterwaul.syntax("[]",new caterwaul.syntax("o").prefix(" "),new caterwaul.syntax("k")))))).prefix(" ")).prefix(" ")),new caterwaul.syntax("return",new caterwaul.syntax("ps").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax("")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("l").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("o").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("l").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("i")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("o").prefix(" "),new caterwaul.syntax("i"))).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("x"),new caterwaul.syntax("0"))),new caterwaul.syntax("[]",new caterwaul.syntax("x").prefix(" "),new caterwaul.syntax("1"))).prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("r").prefix(" ")).prefix(" ")),new caterwaul.syntax(";",new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax(";",new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("r").prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax("")).prefix(" ")).prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("0").prefix(" ")).prefix(" ")),new caterwaul.syntax("=",new caterwaul.syntax("l").prefix(" "),new caterwaul.syntax(".",new caterwaul.syntax("o").prefix(" "),new caterwaul.syntax("length"))).prefix(" ")),new caterwaul.syntax("x").prefix(" "))),new caterwaul.syntax("<",new caterwaul.syntax("i").prefix(" "),new caterwaul.syntax("l").prefix(" ")).prefix(" ")),new caterwaul.syntax("u++",new caterwaul.syntax("i")).prefix(" "))).prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("=",new caterwaul.syntax("x").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("o").prefix(" "),new caterwaul.syntax("i"))).prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("(",new caterwaul.syntax("||",new caterwaul.syntax("[]",new caterwaul.syntax("r"),new caterwaul.syntax("[]",new caterwaul.syntax("x"),new caterwaul.syntax("0"))),new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("[]",new caterwaul.syntax("r"),new caterwaul.syntax("[]",new caterwaul.syntax("x"),new caterwaul.syntax("0"))),new caterwaul.syntax("[",new caterwaul.syntax("")).prefix(" ")).prefix(" ")).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("push")),new caterwaul.syntax("[]",new caterwaul.syntax("x"),new caterwaul.syntax("1"))))),new caterwaul.syntax("return",new caterwaul.syntax("r").prefix(" ")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("n"),new caterwaul.syntax("_u"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("ni"),new caterwaul.syntax("_u"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("n"),new caterwaul.syntax(",",new caterwaul.syntax("_l"),new caterwaul.syntax("_u").prefix(" ")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("ni"),new caterwaul.syntax(",",new caterwaul.syntax("_l"),new caterwaul.syntax("_u").prefix(" ")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("n"),new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("_l"),new caterwaul.syntax("_u").prefix(" ")),new caterwaul.syntax("_step").prefix(" ")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("[]",new caterwaul.syntax("ni"),new caterwaul.syntax(",",new caterwaul.syntax(",",new caterwaul.syntax("_l"),new caterwaul.syntax("_u").prefix(" ")),new caterwaul.syntax("_step").prefix(" ")))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("/",new caterwaul.syntax("_o"),new caterwaul.syntax("keys")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("|",new caterwaul.syntax("_o"),new caterwaul.syntax("object")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("/",new caterwaul.syntax("_o"),new caterwaul.syntax("mobject")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("/",new caterwaul.syntax("_o"),new caterwaul.syntax("values")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("-",new caterwaul.syntax("_o"),new caterwaul.syntax("object")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("-",new caterwaul.syntax("_o"),new caterwaul.syntax("mobject")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("/",new caterwaul.syntax("_o"),new caterwaul.syntax("pairs")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("/",new caterwaul.syntax("_o"),new caterwaul.syntax("object")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("|",new caterwaul.syntax("_o"),new caterwaul.syntax("mobject")).prefix(" "))));
caterwaul.module("std",function(a){a.js_all=function(){return this("js js_literals words seq")};a.all.push("js_all")});caterwaul.module("catastrophe",(function(I,i,h,g,f,e,d,c,b,a,bH,bG,bF,bE,bD,bC,bB,bA,bz,by,bw,bv,bu,bt,bs,br,bq,bp,bo,bn,bm,bl,bk,bi,bg,be,bj,bh,bf,bd,bc,bb,ba,a9,a8,a7,aW,aV,aU,aT,aS,aR,aQ,aP,aO,aN,aM,aL,aK,aI,aG,aE,aC,aA,ay,aw,au,ar,ap,ao,an,al,bI,am,a6,a5,a4,a3,a2,a1,a0,aZ,aY,aX,ak,aj,ai,ah,ag,af,ae,ad,ac,ab,aa,Z,Y,X,V,U,T,S,R,Q,P,O,N,M,L,K,aJ,aH,aF,aD,aB,az,ax,av,at,aq,J,H,G,F,E,D,C,B,A,z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,W){var bx=(function(bJ){(function(){var bQ=bJ.context,bV=function(b3,b1,b2){return bJ.merge(b3,{xs:b1,pattern:b2},bX)
},bX={function_compiler:bJ(":all"),promote:function(b1){return b1.constructor===Function?b1:this.compile_string(b1)},compile_string:function(b1){return this.function_compiler(b1,this.match_variables_for(this.pattern),{unbound_closure:true})
},match_variables_for:function(b1){return(function(b6){for(var b5={},b4=0,b3=b6.length,b2;b4<b3;++b4){b2=b6[b4],b5[b2[0]]=b2[1]}return b5}).call(this,((function(b4){var b2,b6,b3,b7,b5;
for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;++b3){b2=b4[b3],b5.push(([b2.toString(),true]))}return b5}).call(this,((["_","x","xs","xi","r","v","t","d","dt"]).concat((b1.collect(function(b2){return b2.is_wildcard()
})))))))},iteration_context:function(b1){return bJ.merge((this.pattern).match(this.xs[b1].tree())||{},{x:this.xs[b1]},(function(){var b4=this.xs,b7=function(cb){return(function(cd){var ch,cg,cc,ci,cf;
for(var ci=cd.length,cc=ci-1,ch,ce;cc>=0;--cc){ch=cd[cc];if(cg=(cc<=b1?ch.tree().id===cb.id:(cc=b1+1,0))){return cc}}return false}).call(this,b4)},b6=b1,b9=function(cb){return b2(cb).value
},b8=b4[b6].tree(),ca=function(cb){return b2(cb).time},b5=function(cb){return b1-b7(cb)},b2=function(cb){return b4[b7(cb)]},b3=function(cb){return b4[b6].time-b2(cb).time
};return{xs:b4,ri:b7,xi:b6,v:b9,_:b8,t:ca,d:b5,r:b2,dt:b3}}).call(this))},select:function(b1){return bV(b1,this.xs,this.pattern)},get:function(b1){return this.xs[this[(b1+this.length)%this.length]]
},map:function(b1){return(function(){var b2=this.promote(b1);return(function(b5){var b3,b7,b4,b8,b6;for(var b6=new b5.constructor(),b4=0,b8=b5.length;b4<b8;++b4){b3=b5[b4],b6.push((b2(this.iteration_context(b3))))
}return b6}).call(this,this)}).call(this)},filter:function(b1){return(function(){var b2=this.promote(b1);return this.select((function(b5){var b3,b7,b4,b8,b6;for(var b6=new b5.constructor(),b4=0,b8=b5.length;
b4<b8;++b4){b3=b5[b4],(b2(this.iteration_context(b3)))&&b6.push(b3)}return b6}).call(this,this))}).call(this)},preorder:function(){return this.select(Array.prototype.slice.call((this)).sort((function(){var b1=this.xs;
return(function(b3,b2){return b1[b3].pre_id-b1[b2].pre_id})}).call(this)))},postorder:function(){return this.select(Array.prototype.slice.call((this)).sort((function(){var b1=this.xs;
return(function(b3,b2){return b1[b3].id-b1[b2].id})}).call(this)))},resolved:function(){return this.select((function(b3){var b1,b5,b2,b6,b4;for(var b4=new b3.constructor(),b2=0,b6=b3.length;
b2<b6;++b2){b1=b3[b2],(this.xs[b1].resolved)&&b4.push(b1)}return b4}).call(this,this))},unresolved:function(){return this.select((function(b3){var b1,b5,b2,b6,b4;
for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;++b2){b1=b3[b2],(this.xs[b1].resolved)||b4.push(b1)}return b4}).call(this,this))},to_a:function(){return(function(b3){var b1,b5,b2,b6,b4;
for(var b4=new b3.constructor(),b2=0,b6=b3.length;b2<b6;++b2){b1=b3[b2],b4.push((this.xs[b1]))}return b4}).call(this,this)},toString:function(b1){return(function(b2){return b2.join(", ")
}).call(this,((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;++b3){b2=b4[b3],b5.push((("["+(b2.tree().toString(b1||5))+"]")))
}return b5}).call(this,this.to_a())))},first:function(b1){return this.select(this.slice(0,b1||1))},last:function(b1){return this.select(this.slice(this.length-(b1||1)))
},next:function(b1){var b1=bJ.parse(b1);return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;++b3){b2=b4[b3],b5.push((b2-1))
}return b5}).call(this,(function(b5){var b8,b7,b4,b2,b6;for(var b6=new b5.constructor(),b4=0,b2=b5.length,b3;b4<b2;++b4){b8=b5[b4],(b3=((function(cc){var b9,ce,ca,cf,cd;
for(var b9,ca=0,cf=cc.length,cb;ca<cf;++ca){b9=cc[ca];if(ce=(ca>b8?(b1).match(b9.tree()):(ca=b8,0))){return ca+1}}return false}).call(this,this.xs)))&&b6.push(b3)
}return b6}).call(this,this)))},prev:function(b1){var b1=bJ.parse(b1);return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;
b3<b7;++b3){b2=b4[b3],b5.push((b2-1))}return b5}).call(this,(function(b5){var b8,b7,b4,b2,b6;for(var b6=new b5.constructor(),b4=0,b2=b5.length,b3;b4<b2;++b4){b8=b5[b4],(b3=((function(cc){var b9,ce,ca,cf,cd;
for(var cf=cc.length,ca=cf-1,b9,cb;ca>=0;--ca){b9=cc[ca];if(ce=(ca<b8?(b1).match(b9.tree()):(ca=b8,0))){return ca+1}}return false}).call(this,this.xs)))&&b6.push(b3)
}return b6}).call(this,this)))},interval:function(b1){return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;
++b3){b2=b4[b3],b5.push.apply(b5,Array.prototype.slice.call(((function(b9,b8,ca){if((b8-b9)*ca<0||!ca){return[]}for(var cb=[],cc=b8-b9;cc>=0?b9<=b8:b9>=b8;b9+=ca){cb.push(b9)
}return cb})((b2),(b1[b3]),(1)))))}return b5}).call(this,this))},step:function(b1){return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;
b3<b7;++b3){b2=b4[b3],(this.xs[b2])&&b5.push(b2)}return b5}).call(this,(function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;++b3){b2=b4[b3],b5.push((b2+b1))
}return b5}).call(this,this)))},forward:function(b1){return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;
++b3){b2=b4[b3],b5.push.apply(b5,Array.prototype.slice.call(((function(ca){var b8,cc,b9,cd,cb;for(var cb=new ca.constructor(),b9=0,cd=ca.length;b9<cd;++b9){b8=ca[b9],(this.xs[b8])&&cb.push(b8)
}return cb}).call(this,(function(b9,b8,ca){if((b8-b9)*ca<0||!ca){return[]}for(var cb=[],cc=b8-b9;cc>=0?b9<=b8:b9>=b8;b9+=ca){cb.push(b9)}return cb})((b2),(b2+b1),(1))))))
}return b5}).call(this,this))},backward:function(b1){return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;
++b3){b2=b4[b3],b5.push.apply(b5,Array.prototype.slice.call(((function(ca){var b8,cc,b9,cd,cb;for(var cb=new ca.constructor(),b9=0,cd=ca.length;b9<cd;++b9){b8=ca[b9],(this.xs[b8])&&cb.push(b8)
}return cb}).call(this,(function(b9,b8,ca){if((b8-b9)*ca<0||!ca){return[]}for(var cb=[],cc=b8-b9;cc>=0?b9<=b8:b9>=b8;b9+=ca){cb.push(b9)}return cb})((b2-b1),(b2),(1))))))
}return b5}).call(this,this))},adjacent:function(b1){return this.select((function(b4){var b2,b6,b3,b7,b5;for(var b5=new b4.constructor(),b3=0,b7=b4.length;b3<b7;
++b3){b2=b4[b3],b5.push.apply(b5,Array.prototype.slice.call(((function(ca){var b8,cc,b9,cd,cb;for(var cb=new ca.constructor(),b9=0,cd=ca.length;b9<cd;++b9){b8=ca[b9],(this.xs[b8])&&cb.push(b8)
}return cb}).call(this,(function(b9,b8,ca){if((b8-b9)*ca<0||!ca){return[]}for(var cb=[],cc=b8-b9;cc>=0?b9<=b8:b9>=b8;b9+=ca){cb.push(b9)}return cb})((b2-b1),(b2+b1),(1))))))
}return b5}).call(this,this))},to:function(b1){return(this).interval(this.next(b1))},from:function(b1){return(this.prev(b1)).interval(this)}},bM=function(b1){return(function(){var b5=function(cf,ce){return arguments.length===2?cc(cf,ce):b3(cf)
},b3=function(ce){return b8.push(cb=b4(ce))},cc=function(cf,ce){return((b7(cf,ce),b1.trace_log_size&&b8.length>b1.trace_log_size<<1&&cd()),ce)},cd=function(){return b8.splice(b8.length-b1.trace_log_size,b1.trace_log_size)
},b9=function(ce){return(function(cf){return cb=(cb).find_sync(ce),cf}).call(this,(cb))},b4=function(ce){return bJ.merge(new b6(ce),{pre_time:+new Date(),pre_id:++b2,bt:cb,resolved:false})
},b7=function(cf,ce){return(function(){var cg=b1.pre_trace?b9(cf):new b6(cf);return(bJ.merge(cg,{value:ce,time:+new Date(),id:++b2,resolved:true}),!b1.pre_trace&&(b8).push(cg))
}).call(this)},ca={tree:function(){return b1.index[this.tree_id]},backtrace:function(){return(function(cg){var ce,ci,cf,cj,ch;for(var ch=[],ce=cg,cf=0,ci;ci=(ce);
++cf){ch.push(ce),ce=(ce.bt)}return ch}).call(this,this)},last_resolution:function(){return this.resolved||!this.bt?this:this.bt.last_resolution()},find_sync:function(ce){return this.tree_id===ce?this:this.bt.find_sync(ce)
},dt:function(){return this.time-this.pre_time},contains:function(ce){return !b1.pre_trace||ce.id>=this.pre_id&&ce.id<=this.id},toString:function(){return(""+(this.resolved?"R":"U")+"["+(this.pre_id)+", "+(this.id)+"]: "+(this.tree())+"")
}},b6=(function(ce){return bJ.merge(ce.prototype,ca),ce}).call(this,(function(ce){return(this.tree_id=ce,this)})),b2=0,cb=null,b8=b1.trace_log;return b5}).call(this)
},bP=function(b2,b3,b1){return(function(){var b5=b3.late_bound_tree(new b3.opaque_tree(b3.module(b1))),b4=b3.compile(b2(b5),{caterwaul:b3},{gensym_renaming:false});
return b3.module(b1,b4)}).call(this)},bR=function(b1){return(function(){var b7={mocks:{},allow_mock_annotations:true,trace_native_eval_forms:true,environment:{},closures:true,hook_name:bJ.gensym("hook"),hook:null,global:bQ,trace_log_size:1<<20,patterns:null,trace:true,pre_trace:true,hook_form:null,pre_hook_form:null},b4=bJ.merge({},b7,b1),b2=function(){return b6.apply(this,arguments)
},b3=b4.trace_native_eval_forms?bS(b4.hook_name):{},b5=bJ.merge(b3,b4.mocks),b6=(function(b8){return b8.install_hook(),b8}).call(this,(bJ.merge(bN(bJ.merge(b4,{mocks:b5,trace_log:[],index:{},patterns:b4.patterns&&(function(cc){var b8,cb,cd,b9,ca;
for(var ca=new cc.constructor(),cd=0,b9=cc.length;cd<b9;++cd){b8=cc[cd],ca.push((bJ.parse(b8)))}return ca}).call(this,b4.patterns)})),(function(){var cl=b4,ck=function(){return this.find("_").unresolved()
},ce=function(){return this.find("_").unresolved()},cb=function(cm){return this.find("_").first(cm)},cj=function(cm){return this.find("_").last(cm)},cd=function(cm){var cm=bJ.parse(cm);
return(function(){var cn=null;return bV((function(cq){var co,cs,cp,ct,cr;for(var cr=new cq.constructor(),cp=0,ct=cq.length;cp<ct;++cp){co=cq[cp],cr.push((co-1))}return cr
}).call(this,(function(cq){var co,cs,cp,cu,cr;for(var cr=new cq.constructor(),cp=0,cu=cq.length,ct;cp<cu;++cp){co=cq[cp],(ct=((cn=co.tree())&&(cm).match(cn)&&cp+1))&&cr.push(ct)
}return cr}).call(this,cc)),cc,cm)}).call(this)},b8=function(cn,cm){return bP(this,cn,cm)},cf=function(cm){return(cm.toString()).indexOf(bJ.gensym_entropy())>-1},ch=function(cn,cm){return cm?cn.call(cl.hook,cm):cn.call(cl.hook)
},cc=cl.trace_log,cg=cl.hook?cl.hook:cl.hook=bM(cl),ci=cl.global&&(cg.trace_eval?cg.trace_eval:cg.trace_eval=bK(b2)),ca=function(){return cl.global&&(cl.global[cl.hook_name]=cg)
},b9=function(){return cl.global&&delete cl.global[cl.hook_name]};return{options:cl,resolved:ck,unresolved:ce,first:cb,last:cj,find:cd,trace_module:b8,is_traced:cf,closure_state:ch,trace_log:cc,hook:cg,trace_eval:ci,install_hook:ca,remove_hook:b9}
}).call(this))));return b6}).call(this)},bL=function(b1){return(function(){var b2=function(b4,b3){return(function(){var cj=function(){return(((((b9).concat((co))).concat((cf))).concat((b8))).concat((b6))).concat((cb))
},ci=function(){return(function(){var cr=b1.allow_mock_annotations?b3:function(cs){return cs},cq=function(cs){return cs.constructor===Function?cs:cr(bJ.parse(cs))
};return(function(cu){var cs,cw,ct,cx,cv;for(var cv=new cu.constructor(),ct=0,cx=cu.length;ct<cx;++ct){cs=cu[ct],cv.push((cd(b3(bJ.parse(cs[0])),cq(cq(cs[1])))))
}return cv}).call(this,(function(cu){var ct=[];for(var cs in cu){Object.prototype.hasOwnProperty.call(cu,cs)&&ct.push([cs,cu[cs]])}return ct}).call(this,(b1.mocks)))
}).call(this)},cg=function(cq){return(function(){var cr=function(cs){return(function(ct){return ct&&this(ct)}).call(this,(cq.call(this,cs)))};return cr}).call(this)
},cd=function(cq,cr){return cg((I).match(cr)?(function(){var cs=b4(cq,cr);return function(ct){return(function(cu){return cu&&(ct[1].id(),cu[1].id=ct[1].id),cu}).call(this,(cs.call(this,ct)))
}}).call(this):b4(cq,cr))},b9=[cd(i,h)],co=[cd(g,f),cd(e,d),cd(c,b),cd(a,bH),cd(bG,bF),cd(bE,bD),cd(bC,bB),cd(bA,bz),cd(by,bw),cd(bv,bu),cd(bt,bs),cd(br,bq),cd(bp,bo),cd(bn,bm),cd(bl,bk),cd(bi,bg),cd(be,bj),cd(bh,bf),cd(bd,bc),cd(bb,ba),cd(a9,a8),cd(a7,aW),cd(aV,aU),cd(aT,aS),cd(aR,aQ),cd(aP,aO),cd(aN,aM),cd(aL,aK),cd(aI,aG),cd(aE,aC)],cf=[cd(aA,ay),cd(aw,au),cd(ar,ap),cd(ao,an)],b8=(function(){var cr=al,cq=bI;
return(([cd(am,a6),cd(a5,a4),cd(a3,a2),cd(a1,a0),cd(aZ,aY),cd(aX,ak),cd(aj,ai),cd(ah,ag),cd(af,ae),cd(ad,ac),cd(ab,aa),cd(Z,Y),cd(X,V),cd(U,T),cd(S,R),cd(Q,P),cd(O,N),cd(M,L),cd(K,aJ),cd(aH,aF),cd(aD,aB),cd(az,ax),cd(av,at),cd(aq,J),cd(H,G),cd(F,E),cd(D,C),cd(B,A)]).concat(((function(cu){var cs,cw,ct,cx,cv;
for(var cv=new cu.constructor(),ct=0,cx=cu.length;ct<cx;++ct){cs=cu[ct],cv.push((cd(cs[0],cs[1])))}return cv}).call(this,((cr).concat((cq))))))).concat(([cd(z,y),cd(x,w),cd(v,u)]))
}).call(this),cn=new bJ.syntax(b1.hook_name),cm=(bJ.parse(b1.pre_hook_form)||t).replace({hook:cn}),ce=(bJ.parse(b1.hook_form)||s).replace({hook:cn}),ch=function(cq){return cq.without_markers?cq.without_markers:cq.without_markers=((cq.data==="[]"&&bJ.is_gensym(cq[0].data)?cq[1]:cq)).map(ch)
},ca=function(cq){return cq.is_constant()||b1.patterns&&(function(cu){var cr,cw,cs,cx,cv;for(var cr,cs=0,cx=cu.length,ct;cs<cx;++cs){cr=cu[cs];if(ct=((cr).match(ch(cq)))){return false
}}return true}).call(this,b1.patterns)?cq:((b1.pre_trace?cm:ce)).replace({_tree:bJ.syntax.from_string(cq.id()),_value:cq})},b6=[cd(r,(b1.trace?function(cq){return ca(cq._x)
}:q))],cc=function(cq){return cq.replace(/^@/,"")},ck=p,cl=function(cq){return(o).replace({_name:bJ.syntax.from_string(cc(cq)),_v:cc(cq)})},b7=function(cq){return bJ.syntax.from_object((function(cv){for(var cu={},ct=0,cs=cv.length,cr;
ct<cs;++ct){cr=cv[ct],cu[cr[0]]=cr[1]}return cu}).call(this,((function(ct){var cr,cv,cs,cw,cu;for(var cu=new ct.constructor(),cs=0,cw=ct.length;cs<cw;++cs){cr=ct[cs],cu.push(([cc(cr),new bJ.syntax(cc(cr))]))
}return cu}).call(this,(function(cs){var ct=[];for(var cr in cs){Object.prototype.hasOwnProperty.call(cs,cr)&&ct.push(cr)}return ct}).call(this,(cq))))))},b5=function(cq){return(function(cr){return cr.length?cr:bJ.empty
}).call(this,(new bJ.syntax(",",(function(cv){var cr,cu,cw,cs,ct;for(var ct=new cv.constructor(),cw=0,cs=cv.length;cw<cs;++cw){cr=cv[cw],ct.push((cl(cr)))}return ct
}).call(this,(function(cs){var ct=[];for(var cr in cs){Object.prototype.hasOwnProperty.call(cs,cr)&&ct.push(cr)}return ct}).call(this,(cq)))).unflatten()))},cp=function(cq){return(ck).replace({_hook:b1.hook_name,_get:b7(cq),_set:b5(cq)})
},cb=[cd(n,(b1.closures?function(cq){return cp(cq._scope.metadata)}:m))];return(cj()).concat((ci()))}).call(this)};return(function(){var b3=bJ.grammar(["L","U","R","C","H","S"],{initial:"S[_x]",fix:false},b2),b4=function(b7){return(b7).reach(function(b8){return b1.index[b8.id()]=b8
})},b6=function(b7){return(b7).rmap(function(b8){return(function(b9){return b9!==b8?b6(b9):b8}).call(this,(b8.reduce()))})},b5=function(b7){return b3({_x:bZ(b4(b6(b7)),b1)})
};return b5}).call(this)}).call(this)},bT=function(b2,b1){return(b2(b1),(b1).each(function(b3){return !(b3.data==="function")&&bT(b2,b3)}))},bO=function(b1){return b1!=="this"&&b1!=="arguments"
},bY=function(b1){return(function(){var b2=function(b4){return b4.is_identifier()&&bO(b4.data)&&(b3[("@"+(b4.data)+"")]=b4)},b3={};return(bT(b2,bJ.parse(b1)),b3)
}).call(this)},bU=function(b1){return(function(){var b2=function(b6){return b6.data==="var"&&b4(b6[0].flatten(","))},b4=function(b6){return(function(b7){return b7.data==="in"?b3[("@"+(b7[0].data)+"")]=b7:b5(b6)
}).call(this,(b6[0].flatten("=")[0]))},b5=function(b6){return(function(b9){var b7,cb,b8,cc,ca;for(var b8=0,cc=b9.length;b8<cc;++b8){b7=b9[b8],(b3["@"+b7.flatten("=")[0].data]=b7)
}return b9}).call(this,b6)},b3=(function(ca){for(var b9={},b8=0,b7=ca.length,b6;b8<b7;++b8){b6=ca[b8],b9[b6[0]]=b6[1]}return b9}).call(this,((function(b8){var b6,ca,b7,cb,b9;
for(var b9=new b8.constructor(),b7=0,cb=b8.length;b7<cb;++b7){b6=b8[b7],b9.push((["@"+b6.data,b6]))}return b9}).call(this,(function(b8){var b6,ca,b7,cb,b9;for(var b9=new b8.constructor(),b7=0,cb=b8.length;
b7<cb;++b7){b6=b8[b7],(b6.data.length)&&b9.push(b6)}return b9}).call(this,Array.prototype.slice.call((b1[0][0].flatten(",")))))));return(bT(b2,bJ.parse(b1)),b3)}).call(this)
},bW=function(b1){return(function(){var b2=bU(b1);return(function(b5){var b3,b7,b4,b8,b6;var b6=new b5.constructor();for(var b3 in b5){if(Object.prototype.hasOwnProperty.call(b5,b3)&&!(Object.prototype.hasOwnProperty.call(b2,b3))){b6[b3]=b5[b3]
}}return b6}).call(this,bY(b1))}).call(this)},b0=function(b1){return function(b2){return(function(b3){return b3[0][0]=new bJ.syntax(";",b3[0][0]||bJ.empty,new bJ.metadata_node(b1.closures&&bW(b2),"scope")),b3
}).call(this,(b2))}},bZ=function(b2,b1){return(function(){var b3=b0(b1);return((function(b8){var b4,b7,b9,b5,b6;for(var b9=0,b5=b8.length;b9<b5;++b9){b4=b8[b9],(b3(b4))
}return b8}).call(this,b2.collect(function(b4){return b4.data==="function"})),b2)}).call(this)},bK=function(b1){return function(b2){return b1(bJ.parse(b2)).toString()
}},bS=function(b1){return(function(){var b2=(l).replace({hook:b1});return(function(b5){var b3,b7,b4,b9,b6;var b6=new b5.constructor();for(var b8 in b5){if(Object.prototype.hasOwnProperty.call(b5,b8)){b3=b5[b8],b6[b8]=((b3).replace({trace:b2}))
}}return b6}).call(this,{"R[eval(_x)]":k,"R[new Function(_x)]":j,"R[new Function(_xs, _x)]":W})}).call(this)},bN=function(b1){return(function(){var b4=bL(b1),b3=bJ(b4),b2=function(b5,b6){return b5.constructor===String?this.find.apply(this,arguments):b3(b5,bJ.merge({},b1.environment,b6),{transparent_errors:false,gensym_renaming:false})
};return b2}).call(this)};return(function(){var b1={caterwaul:bJ,local_scope:bU,immediate_scope:bY,closure_scope:bW};return bJ.merge((catastrophe=bR),b1)}).call(this)
}).call(this)});bx.caterwaul_expression_ref_table={qs:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "_x"))'),qs1:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U") ,new caterwaul.syntax( "_x"))'),qs2:(' new caterwaul.syntax( "")'),qs3:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x"))'),qs4:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))'),qs5:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x")))'),qs6:(' new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x")))'),qs7:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y") .prefix( " ")))'),qs8:(' new caterwaul.syntax( "i;" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_y")))'),qs9:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y") .prefix( " ")))'),qsa:(' new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_y")))'),qsb:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_vs") .prefix( " ") ,new caterwaul.syntax( "_x") .prefix( " "))))'),qsc:(' new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_vs") .prefix( " "))) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_x")))'),qsd:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " ")))'),qse:(' new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_cond"))) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))'),qsf:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_vs") .prefix( " ") ,new caterwaul.syntax( "_name@0") .prefix( " "))))'),qsg:(' new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_vs") .prefix( " "))) ,new caterwaul.syntax( "_name") .prefix( " "))'),qsh:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " ") ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "_else") .prefix( " ")) .prefix( " ")))'),qsi:(' new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_cond"))) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")) ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_else"))) .prefix( " "))'),qsj:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_vs") .prefix( " ") ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name") .prefix( " ") ,new caterwaul.syntax( "_value") .prefix( " ")) .prefix( " "))))'),qsk:(' new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_vs") .prefix( " "))) ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name") .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_value"))) .prefix( " "))'),qsl:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "_name@0") .prefix( " ")))'),qsm:(' new caterwaul.syntax( "var" ,new caterwaul.syntax( "_name") .prefix( " "))'),qsn:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "throw" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qso:(' new caterwaul.syntax( "throw" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_x")))'),qsp:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name") .prefix( " ") ,new caterwaul.syntax( "_value") .prefix( " ")) .prefix( " ")))'),qsq:(' new caterwaul.syntax( "var" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_name") .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_value"))) .prefix( " "))'),qsr:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "var" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name") .prefix( " ") ,new caterwaul.syntax( "_value") .prefix( " ")) .prefix( " ")))'),qss:(' new caterwaul.syntax( "var" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name") .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_value"))) .prefix( " "))'),qst:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_x")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " ")))'),qsu:(' new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x"))) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))'),qsv:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "do" ,new caterwaul.syntax( "_body") .prefix( " ") ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond")) .prefix( " ")) .prefix( " ")))'),qsw:(' new caterwaul.syntax( "do" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_body")) ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_cond"))) .prefix( " ")) .prefix( " "))'),qsx:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_cond")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " ")))'),qsy:(' new caterwaul.syntax( "while" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_cond"))) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))'),qsz:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "with" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_x")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " ")))'),qs10:(' new caterwaul.syntax( "with" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))'),qs11:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "continue" ,new caterwaul.syntax( "_label") .prefix( " ")))'),qs12:(' new caterwaul.syntax( "continue" ,new caterwaul.syntax( "_label") .prefix( " "))'),qs13:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "continue"))'),qs14:(' new caterwaul.syntax( "continue")'),qs15:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "break" ,new caterwaul.syntax( "_label") .prefix( " ")))'),qs16:(' new caterwaul.syntax( "break" ,new caterwaul.syntax( "_label") .prefix( " "))'),qs17:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "break"))'),qs18:(' new caterwaul.syntax( "break")'),qs19:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qs1a:(' new caterwaul.syntax( "return" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_x")))'),qs1b:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "return"))'),qs1c:(' new caterwaul.syntax( "return")'),qs1d:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name") ,new caterwaul.syntax( "_v") .prefix( " ")) .prefix( " ")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " ")))'),qs1e:(' new caterwaul.syntax( "for" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_v"))) .prefix( " ")) .prefix( " ") ,new caterwaul.syntax( "_body") .prefix( " "))'),qs1f:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "switch") ,new caterwaul.syntax( "_value")) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_cases")) .prefix( " ")))'),qs1g:(' new caterwaul.syntax( "i;" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "switch") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_value"))) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_cases"))) .prefix( " "))'),qs1h:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y") .prefix( " ")))'),qs1i:(' new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_y")))'),qs1j:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "_f") .prefix( " ") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_xs") ,new caterwaul.syntax( "_scope") .prefix( " "))) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body")) .prefix( " ")))'),qs1k:(' new caterwaul.syntax( "function" ,new caterwaul.syntax( "_f") .prefix( " ") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs")) ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "C") ,new caterwaul.syntax( "_scope")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))) .prefix( " "))'),qs1l:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x")) .prefix( " ") ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_e")) .prefix( " ") ,new caterwaul.syntax( "_y") .prefix( " ") ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "_z") .prefix( " ")) .prefix( " ")) .prefix( " ")))'),qs1m:(' new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x"))) .prefix( " ") ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_e")) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_y")) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_z"))) .prefix( " ")) .prefix( " "))'),qs1n:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x")) .prefix( " ") ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_e")) .prefix( " ") ,new caterwaul.syntax( "_y") .prefix( " ")) .prefix( " ")))'),qs1o:(' new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x"))) .prefix( " ") ,new caterwaul.syntax( "catch" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_e")) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_y"))) .prefix( " "))'),qs1p:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "i;" ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x")) .prefix( " ")) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "_y") .prefix( " ")) .prefix( " ")))'),qs1q:(' new caterwaul.syntax( "i;" ,new caterwaul.syntax( "try" ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") ,new caterwaul.syntax( "_x"))) .prefix( " ")) ,new caterwaul.syntax( "finally" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_y"))) .prefix( " "))'),qs1r:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "_x@0"))'),qs1s:(' new caterwaul.syntax( "_x")'),qs1t:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),qs1u:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_y")))'),qs1v:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),qs1w:(' new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "_y"))'),qs1x:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),qs1y:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "U") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),ahead:(" (function (xs) {var x, x0, xi, xl, xr;for (var xr = new xs.constructor() , xi = 0, xl = xs.length; xi < xl; ++xi) x = xs[xi] , xr.push( ( [caterwaul.parse( ( 'R[_x ' + (x) + ' _y]')) , caterwaul.parse( ( 'H[R[_x] ' + (x) + ' R[_y]]'))])) ; return xr}) .call(this, [ '+' , '-' , '*' , '/' , '%' , '<<' , '>>' , '>>>' , '<' , '>' , '<=' , '>=' , 'instanceof' , 'in' , '==' , '!=' , '===' , '!==' , '&' , '^' , '|' , '&&' , '||'])"),ahead1:(" (function (xs) {var x, x0, xi, xl, xr;for (var xr = new xs.constructor() , xi = 0, xl = xs.length; xi < xl; ++xi) x = xs[xi] , xr.push( ( [caterwaul.parse( ( 'R[_x ' + (x) + ' _y]')) , caterwaul.parse( ( 'H[L[_x] ' + (x) + ' R[_y]]'))])) ; return xr}) .call(this, [ '=' , '+=' , '-=' , '*=' , '/=' , '%=' , '<<=' , '>>=' , '>>>=' , '&=' , '|=' , '^='])"),qs1z:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))'),qs20:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "_x"))'),qs21:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( ""))'),qs22:(' new caterwaul.syntax( "")'),qs23:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")))'),qs24:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))'),qs25:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "_x")))'),qs26:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "_x"))'),qs27:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qs28:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))) .prefix( " ")))'),qs29:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_f") .prefix( " ") ,new caterwaul.syntax( "_xs"))))'),qs2a:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_f"))) .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_xs")))))'),qs2b:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "delete" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qs2c:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "delete" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") .prefix( " ") ,new caterwaul.syntax( "_x"))))'),qs2d:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),qs2e:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "_y")))'),qs2f:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_x")))'),qs2g:(' new caterwaul.syntax( "(" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")))'),qs2h:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),qs2i:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_y"))))'),qs2j:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "_x")))'),qs2k:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "[" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))'),qs2l:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y") .prefix( " ")))'),qs2m:(' new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_y")))'),qs2n:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_x")))'),qs2o:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))'),qs2p:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")))'),qs2q:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_y"))))'),qs2r:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")) ,new caterwaul.syntax( "_z")))'),qs2s:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "_y")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_z"))))'),qs2t:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y")) ,new caterwaul.syntax( "_z")))'),qs2u:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_y"))) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_z"))))'),qs2v:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "void" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qs2w:(' new caterwaul.syntax( "void" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_x")))'),qs2x:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qs2y:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_x"))))'),qs2z:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y") .prefix( " ")))'),qs30:(' new caterwaul.syntax( ":" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_y")))'),qs31:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x@0") .prefix( " ")))'),qs32:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "typeof" ,new caterwaul.syntax( "_x") .prefix( " ")))'),qs33:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "u+" ,new caterwaul.syntax( "_x")))'),qs34:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "u+" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))'),qs35:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "u~" ,new caterwaul.syntax( "_x")))'),qs36:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "u~" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))'),qs37:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "u-" ,new caterwaul.syntax( "_x")))'),qs38:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "u-" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))'),qs39:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "_x")))'),qs3a:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "u!" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))'),qs3b:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "_x")))'),qs3c:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "u++" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "_x"))))'),qs3d:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "++" ,new caterwaul.syntax( "_x")))'),qs3e:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "++" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "_x"))))'),qs3f:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "u--" ,new caterwaul.syntax( "_x")))'),qs3g:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "u--" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "_x"))))'),qs3h:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "--" ,new caterwaul.syntax( "_x")))'),qs3i:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "--" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "L") ,new caterwaul.syntax( "_x"))))'),qs3j:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "_x") ,new caterwaul.syntax( "_y") .prefix( " ") .infix( " ") ,new caterwaul.syntax( "_z") .prefix( " ")) .prefix( " "))'),qs3k:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "?" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_y")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") .prefix( " ") ,new caterwaul.syntax( "_z"))) .prefix( " "))'),qs3l:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_xs") ,new caterwaul.syntax( "_scope") .prefix( " "))) .prefix( " ") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body")) .prefix( " ")))'),qs3m:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs")) .prefix( " ") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "C") ,new caterwaul.syntax( "_scope")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))) .prefix( " ")))'),qs3n:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "_f") .prefix( " ") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "_xs") ,new caterwaul.syntax( "_scope") .prefix( " "))) .prefix( " ") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( "_body")) .prefix( " ")))'),qs3o:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "function" ,new caterwaul.syntax( "_f") .prefix( " ") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_xs")) .prefix( " ") ,new caterwaul.syntax( "{" ,new caterwaul.syntax( ";" ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "C") ,new caterwaul.syntax( "_scope")) ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "S") .prefix( " ") ,new caterwaul.syntax( "_body")))) .prefix( " ")))'),qs3p:(' new caterwaul.syntax( "()" ,new caterwaul.syntax( "hook") ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_tree") ,new caterwaul.syntax( "&&" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "hook") .prefix( " ") ,new caterwaul.syntax( "_tree")) ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_value")) .prefix( " ")) .prefix( " ")))'),qs3q:(' new caterwaul.syntax( "()" ,new caterwaul.syntax( "hook") ,new caterwaul.syntax( "," ,new caterwaul.syntax( "_tree") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "_value")) .prefix( " ")))'),qs3r:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "_x"))'),qs3s:(' new caterwaul.syntax( "_x")'),qs3t:(' new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "===" ,new caterwaul.syntax( "this") ,new caterwaul.syntax( "_hook") .prefix( " ")) .prefix( " ")) .prefix( " ") ,new caterwaul.syntax( "if" ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "." ,new caterwaul.syntax( "arguments") ,new caterwaul.syntax( "length"))) .prefix( " ") ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_set") .prefix( " ")) .prefix( " ") ,new caterwaul.syntax( "else" ,new caterwaul.syntax( "return" ,new caterwaul.syntax( "_get") .prefix( " ")) .prefix( " ")) .prefix( " ")) .prefix( " "))'),qs3u:(' new caterwaul.syntax( "&&" ,new caterwaul.syntax( "in" ,new caterwaul.syntax( "_name") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "arguments") .prefix( " ") ,new caterwaul.syntax( "0"))) .prefix( " ") ,new caterwaul.syntax( "(" ,new caterwaul.syntax( "=" ,new caterwaul.syntax( "_v") ,new caterwaul.syntax( "." ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "arguments") .prefix( " ") ,new caterwaul.syntax( "0")) ,new caterwaul.syntax( "_v"))) .prefix( " ")) .prefix( " ")) .prefix( " ")'),qs3v:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "C") ,new caterwaul.syntax( "_scope"))'),qs3w:(' new caterwaul.syntax( "null")'),qs3x:(' new caterwaul.syntax( "." ,new caterwaul.syntax( "hook") ,new caterwaul.syntax( "trace_eval"))'),qs3y:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "eval") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")))))'),qs3z:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "Function") .prefix( " ") ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x"))))))'),qs40:(' new caterwaul.syntax( "[]" ,new caterwaul.syntax( "H") ,new caterwaul.syntax( "new" ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "Function") .prefix( " ") ,new caterwaul.syntax( "," ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_xs")) ,new caterwaul.syntax( "()" ,new caterwaul.syntax( "trace") .prefix( " ") ,new caterwaul.syntax( "[]" ,new caterwaul.syntax( "R") ,new caterwaul.syntax( "_x")))))))')};
return(bx)}).call(this,new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("_x")),new caterwaul.syntax(""),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("{",new caterwaul.syntax("_x"))),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" "))),new caterwaul.syntax("i;",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(";",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" "))),new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("_vs").prefix(" "),new caterwaul.syntax("_x").prefix(" ")))),new caterwaul.syntax(",",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("_vs").prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("_cond")).prefix(" "),new caterwaul.syntax("_body").prefix(" "))),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("_vs").prefix(" "),new caterwaul.syntax("_name@0").prefix(" ")))),new caterwaul.syntax(",",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("_vs").prefix(" "))),new caterwaul.syntax("_name").prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("_cond")).prefix(" "),new caterwaul.syntax("_body").prefix(" "),new caterwaul.syntax("else",new caterwaul.syntax("_else").prefix(" ")).prefix(" "))),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body")),new caterwaul.syntax("else",new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_else"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax(",",new caterwaul.syntax("_vs").prefix(" "),new caterwaul.syntax("=",new caterwaul.syntax("_name").prefix(" "),new caterwaul.syntax("_value").prefix(" ")).prefix(" ")))),new caterwaul.syntax(",",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("_vs").prefix(" "))),new caterwaul.syntax("=",new caterwaul.syntax("_name").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_value"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("_name@0").prefix(" "))),new caterwaul.syntax("var",new caterwaul.syntax("_name").prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("throw",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("throw",new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_name").prefix(" "),new caterwaul.syntax("_value").prefix(" ")).prefix(" "))),new caterwaul.syntax("var",new caterwaul.syntax("=",new caterwaul.syntax("_name").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_value"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_name").prefix(" "),new caterwaul.syntax("_value").prefix(" ")).prefix(" "))),new caterwaul.syntax("var",new caterwaul.syntax("in",new caterwaul.syntax("_name").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_value"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("_x")).prefix(" "),new caterwaul.syntax("_body").prefix(" "))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("do",new caterwaul.syntax("_body").prefix(" "),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("_cond")).prefix(" ")).prefix(" "))),new caterwaul.syntax("do",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("[",new caterwaul.syntax("_body")),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))).prefix(" ")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("_cond")).prefix(" "),new caterwaul.syntax("_body").prefix(" "))),new caterwaul.syntax("while",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_cond"))).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("with",new caterwaul.syntax("(",new caterwaul.syntax("_x")).prefix(" "),new caterwaul.syntax("_body").prefix(" "))),new caterwaul.syntax("with",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("continue",new caterwaul.syntax("_label").prefix(" "))),new caterwaul.syntax("continue",new caterwaul.syntax("_label").prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("continue")),new caterwaul.syntax("continue"),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("break",new caterwaul.syntax("_label").prefix(" "))),new caterwaul.syntax("break",new caterwaul.syntax("_label").prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("break")),new caterwaul.syntax("break"),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("return",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("return",new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("return")),new caterwaul.syntax("return"),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("_v").prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("_body").prefix(" "))),new caterwaul.syntax("for",new caterwaul.syntax("(",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_v"))).prefix(" ")).prefix(" "),new caterwaul.syntax("_body").prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("switch"),new caterwaul.syntax("_value")),new caterwaul.syntax("{",new caterwaul.syntax("_cases")).prefix(" "))),new caterwaul.syntax("i;",new caterwaul.syntax("()",new caterwaul.syntax("switch"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_value"))),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_cases"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" "))),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("function",new caterwaul.syntax("_f").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax("_xs"),new caterwaul.syntax("_scope").prefix(" "))),new caterwaul.syntax("{",new caterwaul.syntax("_body")).prefix(" "))),new caterwaul.syntax("function",new caterwaul.syntax("_f").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_xs")),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("C"),new caterwaul.syntax("_scope")),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body")))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("_x")).prefix(" "),new caterwaul.syntax("catch",new caterwaul.syntax("(",new caterwaul.syntax("_e")).prefix(" "),new caterwaul.syntax("_y").prefix(" "),new caterwaul.syntax("finally",new caterwaul.syntax("_z").prefix(" ")).prefix(" ")).prefix(" "))),new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))).prefix(" "),new caterwaul.syntax("catch",new caterwaul.syntax("(",new caterwaul.syntax("_e")).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y")),new caterwaul.syntax("finally",new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_z"))).prefix(" ")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("_x")).prefix(" "),new caterwaul.syntax("catch",new caterwaul.syntax("(",new caterwaul.syntax("_e")).prefix(" "),new caterwaul.syntax("_y").prefix(" ")).prefix(" "))),new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))).prefix(" "),new caterwaul.syntax("catch",new caterwaul.syntax("(",new caterwaul.syntax("_e")).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("i;",new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("_x")).prefix(" ")),new caterwaul.syntax("finally",new caterwaul.syntax("_y").prefix(" ")).prefix(" "))),new caterwaul.syntax("i;",new caterwaul.syntax("try",new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("S"),new caterwaul.syntax("_x"))).prefix(" ")),new caterwaul.syntax("finally",new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_y"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x@0")),new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("[]",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax(".",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("_y")),new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("U"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),(function(c){var a,e,b,f,d;
...
b<f;++b){a=c[b],d.push(([caterwaul.parse(("R[_x "+(a)+" _y]")),caterwaul.parse(("H[L[_x] "+(a)+" R[_y]]"))]))}return d}).call(this,["=","+=","-=","*=","/=","%=","<<=",">>=",">>>=","&=","|=","^="]),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("")),new caterwaul.syntax(""),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("new",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("new",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))).prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax("_f").prefix(" "),new caterwaul.syntax("_xs")))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_f"))).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_xs"))))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("delete",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("delete",new caterwaul.syntax("[]",new caterwaul.syntax("L").prefix(" "),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax(".",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("(",new caterwaul.syntax("_x"))),new caterwaul.syntax("(",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("[]",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_y")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("[",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("[",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax(",",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" "))),new caterwaul.syntax(",",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("{",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("{",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("()",new caterwaul.syntax("_x"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("()",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_y")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("_x"),new caterwaul.syntax("_y")),new caterwaul.syntax("_z"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("()",new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("_y")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_z")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("()",new caterwaul.syntax("[]",new caterwaul.syntax("_x"),new caterwaul.syntax("_y")),new caterwaul.syntax("_z"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("()",new caterwaul.syntax("[]",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_z")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("void",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("void",new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("typeof",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("typeof",new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" "))),new caterwaul.syntax(":",new caterwaul.syntax("_x"),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_y"))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("typeof",new caterwaul.syntax("_x@0").prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("typeof",new caterwaul.syntax("_x").prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("u+",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("u+",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("u~",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("u~",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("u-",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("u-",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("u!",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("u!",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("u++",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("u++",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("++",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("++",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("u--",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("u--",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("--",new caterwaul.syntax("_x"))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("--",new caterwaul.syntax("[]",new caterwaul.syntax("L"),new caterwaul.syntax("_x")))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("?",new caterwaul.syntax("_x"),new caterwaul.syntax("_y").prefix(" ").infix(" "),new caterwaul.syntax("_z").prefix(" ")).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("?",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_y")),new caterwaul.syntax("[]",new caterwaul.syntax("R").prefix(" "),new caterwaul.syntax("_z"))).prefix(" ")),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax("_xs"),new caterwaul.syntax("_scope").prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax("_body")).prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("function",new caterwaul.syntax("(",new caterwaul.syntax("_xs")).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("C"),new caterwaul.syntax("_scope")),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body")))).prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("function",new caterwaul.syntax("_f").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax(";",new caterwaul.syntax("_xs"),new caterwaul.syntax("_scope").prefix(" "))).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax("_body")).prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("function",new caterwaul.syntax("_f").prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("_xs")).prefix(" "),new caterwaul.syntax("{",new caterwaul.syntax(";",new caterwaul.syntax("[]",new caterwaul.syntax("C"),new caterwaul.syntax("_scope")),new caterwaul.syntax("[]",new caterwaul.syntax("S").prefix(" "),new caterwaul.syntax("_body")))).prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax("hook"),new caterwaul.syntax(",",new caterwaul.syntax("_tree"),new caterwaul.syntax("&&",new caterwaul.syntax("()",new caterwaul.syntax("hook").prefix(" "),new caterwaul.syntax("_tree")),new caterwaul.syntax("(",new caterwaul.syntax("_value")).prefix(" ")).prefix(" "))),new caterwaul.syntax("()",new caterwaul.syntax("hook"),new caterwaul.syntax(",",new caterwaul.syntax("_tree"),new caterwaul.syntax("(",new caterwaul.syntax("_value")).prefix(" "))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("_x")),new caterwaul.syntax("_x"),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax("===",new caterwaul.syntax("this"),new caterwaul.syntax("_hook").prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("if",new caterwaul.syntax("(",new caterwaul.syntax(".",new caterwaul.syntax("arguments"),new caterwaul.syntax("length"))).prefix(" "),new caterwaul.syntax("return",new caterwaul.syntax("_set").prefix(" ")).prefix(" "),new caterwaul.syntax("else",new caterwaul.syntax("return",new caterwaul.syntax("_get").prefix(" ")).prefix(" ")).prefix(" ")).prefix(" ")),new caterwaul.syntax("&&",new caterwaul.syntax("in",new caterwaul.syntax("_name"),new caterwaul.syntax("[]",new caterwaul.syntax("arguments").prefix(" "),new caterwaul.syntax("0"))).prefix(" "),new caterwaul.syntax("(",new caterwaul.syntax("=",new caterwaul.syntax("_v"),new caterwaul.syntax(".",new caterwaul.syntax("[]",new caterwaul.syntax("arguments").prefix(" "),new caterwaul.syntax("0")),new caterwaul.syntax("_v"))).prefix(" ")).prefix(" ")).prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("C"),new caterwaul.syntax("_scope")),new caterwaul.syntax("null"),new caterwaul.syntax(".",new caterwaul.syntax("hook"),new caterwaul.syntax("trace_eval")),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("()",new caterwaul.syntax("eval"),new caterwaul.syntax("()",new caterwaul.syntax("trace"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x"))))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax("Function").prefix(" "),new caterwaul.syntax("()",new caterwaul.syntax("trace"),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))))),new caterwaul.syntax("[]",new caterwaul.syntax("H"),new caterwaul.syntax("new",new caterwaul.syntax("()",new caterwaul.syntax("Function").prefix(" "),new caterwaul.syntax(",",new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_xs")),new caterwaul.syntax("()",new caterwaul.syntax("trace").prefix(" "),new caterwaul.syntax("[]",new caterwaul.syntax("R"),new caterwaul.syntax("_x")))))))));
caterwaul.module("catastrophe.deglobalization",function(a){a.deglobalize()});
...
through to rvalue expressions; this reflects the fact that you can have an expression whose return value is not used.
                  ...
                  statements = ['S[_x]'.qs     /-rule/ 'R[_x]'.qs,
                                ...
                                'S[var _name@0]'.qs              /-rule/ 'var _name'.qs,                  'S[try _x catch _y finally _z]'.qs  /-rule/ 'try S[_x] catch S[_y] finally S[_z]'.qs,
                                'S[var _name = _value]'.qs       /-rule/ 'var _name = R[_value]'.qs,      'S[try _x catch _y]'.qs             /-rule/ 'try S[_x] catch S[_y]'.qs,
                                'S[var _name in _value]'.qs      /-rule/ 'var _name in R[_value]'.qs,     'S[try _x finally _y]'.qs           /-rule/ 'try S[_x] finally S[_y]'.qs,

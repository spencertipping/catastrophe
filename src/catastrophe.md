...
through to rvalue expressions; this reflects the fact that you can have an expression whose return value is not used.
                  ...
                  statements = ['S[_x]'.qs     /-rule/ 'R[_x]'.qs,
                                ...
                                'S[var _name@0]'.qs              /-rule/ 'var L[_name]'.qs,               'S[try _x catch _y finally _z]'.qs  /-rule/ 'try S[_x] catch S[_y] finally S[_z]'.qs,
                                'S[var _name = _value]'.qs       /-rule/ 'var L[_name] = R[_value]'.qs,   'S[try _x catch _y]'.qs             /-rule/ 'try S[_x] catch S[_y]'.qs,
                                'S[var _name in _value]'.qs      /-rule/ 'var L[_name] in R[_value]'.qs,  'S[try _x finally _y]'.qs           /-rule/ 'try S[_x] finally S[_y]'.qs,
                                                                                                          'S[throw _x]'.qs                    /-rule/ 'throw R[_x]'.qs,
                                'S[for (_x) _body]'.qs           /-rule/ 'for (S[_x]) S[_body]'.qs,
                                'S[do _body while (_cond)]'.qs   /-rule/ 'do S[_body] while (R[_cond])'.qs,
                                'S[while (_cond) _body]'.qs      /-rule/ 'while (R[_cond]) S[_body]'.qs,  'S[throw _x; _y]'.qs                /-rule/ 'S[throw _x]; U[_y]'.qs,
                                'S[with (_x) _body]'.qs          /-rule/ 'with (R[_x]) S[_body]'.qs,      'S[return _x; _y]'.qs               /-rule/ 'S[return _x]; U[_y]'.qs,
                                ...
                                'for (_name in _v) _body'.qs     /-rule/ 'for (L[_name] in R[_v]) _body'.qs,    // pathological case; we don't want the 'in' turning to an R[]

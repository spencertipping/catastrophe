            ...
            -where [tracing_rules() = options.trace ? statements + lvalues + rvalues + hooks -seq : [],
                    custom_rules()  = options.mocks /pairs *[x[0] /!$.parse /-rule/ process_mock(x[1] /!$.parse)] -seq
                              -where [annotate           = options.allow_mock_annotations ? anon : "_".qf,
                                      ...
                                      process_mock(tree) = tree /!annotate /!frame],
...
Normally the hook is bound as a global variable, but you can disable this by setting 'global' to null.
            ...
            hook_for(options) = observe -where [observe(x) = null],

            tracer_for(options) = trace -where [default_options = {mocks: {}, trace_mocks: true, allow_mock_annotations: true, trace_native_eval_forms: true, environment: {}, pre_trace: true,
                                                                   trace: true, timestamps: true, hook_name: 'catastrophe_hook' /!$.gensym, hook: null, global: global, trace_log_size: 1000000,
                                                                   trace_log: [], error_log: []},
